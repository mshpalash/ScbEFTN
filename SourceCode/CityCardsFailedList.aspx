<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CityCardsFailedList.aspx.cs" Inherits="EFTN.CityCardsFailedList" MaintainScrollPositionOnPostback="true" %>
...
<body class="wrap" id="content">
    ...
    <uc1:Header ID="Header" runat="server" />
        ...
        <div class="Head" align="center">Cards Failed Transactions</div>
        ...
        <br />
                ...
                <div style="overflow: scroll; height: 350px; width: 400px">
                    <asp:DataGrid ID="dtgXmlUpload" runat="Server" Width="300px" BorderWidth="0px"
