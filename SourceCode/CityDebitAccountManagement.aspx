<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CityDebitAccountManagement.aspx.cs" Inherits="EFTN.CityDebitAccountManagement" MaintainScrollPositionOnPostback="true" %>
...
<body class="wrap" id="content">
    ...
    <uc1:Header ID="Header" runat="server" />
        ...
        <div class="Head" align="center">Debit Account Management</div>
        <div>
            <table>
                <tr>
                    <td class="NormalBold">
        ...
        <div align="center" style="width:940px; height:350px; overflow:scroll; ">
            <asp:datagrid Id="MyDataGrid2"
                ...
                <asp:EditCommandColumn CausesValidation="False" EditText="Edit" UpdateText="Update" CancelText="Cancel"></asp:EditCommandColumn>
                    ...
                    <asp:TemplateColumn HeaderText="AccountName"  ItemStyle-HorizontalAlign="Left" 
                                   FooterStyle-CssClass="red" >
                         <ItemTemplate>
                            <%#DataBinder.Eval(Container.DataItem, "AccountName")%>
                         </ItemTemplate>
                        <EditItemTemplate>
                             <asp:TextBox ID="txtAccountName" Width="90" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "AccountName") %>'></asp:TextBox>
                        </EditItemTemplate>
                         <FooterTemplate>
