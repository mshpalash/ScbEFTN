<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BBReconciliataionReportCA.aspx.cs" Inherits="EFTN.BBReconciliataionReportCA" %>
...
<body class="wrap" id="content">
    <form id="form1" runat="server">
        <div class="maincontent">
                ...
                <table>
                    <tr>
                        ...
                        <td align="center" class="NormalBold">
                                <asp:CheckBox ID="chkBoxDailyVoucher" runat="server" Text="Daily Voucher" />
                        </td>
                        ...
                        <td>
                            <asp:Button ID="GenerteFlatFile" runat="server" Text="Generte Flat File" OnClick="GenerteFlatFile_Click" />
                        </td>
                    </tr>
            ...
            <div id="AvailDiv" runat="server" style="position: relative; overflow: auto; height: 380px; padding-top: 10px; width: 940px; margin-top: 10px; margin-left: 15px">
                <asp:Label ID="lblStatusReport" CssClass="NormalRed" runat="Server"></asp:Label><br />
                <asp:DataGrid ID="dtgBBReconciliataionReportCA" runat="Server" Width="600" BorderWidth="0px"
                    ...
                    <Columns>
                        <asp:BoundColumn DataField="Segment" HeaderText="Segment" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="Narration" HeaderText="Narration" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="NoOfTransaction" HeaderText="No Of Transaction" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="TotalAmount" HeaderText="Amount" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="TranType" HeaderText="Debit/Credit" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" />
