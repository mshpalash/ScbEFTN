<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlatFilesForCSVRejection.aspx.cs"
    Inherits="EFTN.FlatFilesForCSVRejection" %>
        ...
        <div class="maincontent">
            ...
            <div align="center" class="boxmodule" style="padding-top: 10px; width: 800px; margin-top: 10px; height: 40px; margin-left: 100px">
                <table>
                    <tr>
                        <td></td>
                        <td class="NormalBold">CSV Rejected Transactions</td>
                        <td width="30"></td>
                        <td>
                            <table>
                                <tr>
                                    <td class="NormalBold">Entry Date</td>
                                    <td class="NormalBold">
                        ...
                        <td width="30"></td>
                        <td class="Normal">
                            <asp:LinkButton ID="LinkButton1" runat="server" Text="Generate"
                                CssClass="CommandButton" OnClientClick="return confirm('Are you sure you want to generate flat files for CBS?')"
                                OnClick="btnGenerateFlatFileTransactionReceived_Click" /></td>
                        <td>
                ...
                <asp:DataGrid ID="dtgTransactionSentToOwnBank" runat="Server" Width="600" BorderWidth="0px"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="valueDate" HeaderText="valueDate" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="Narration1" HeaderText="Narration" ItemStyle-Wrap="False" ItemStyle-HorizontalAlign="Left"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="A" HeaderText="FCY Narration A" ItemStyle-Wrap="False" ItemStyle-HorizontalAlign="Left"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="B" HeaderText="FCY Narration B" ItemStyle-Wrap="False" ItemStyle-HorizontalAlign="Left"
                            HeaderStyle-Wrap="False" />
                    </Columns>
                </asp:DataGrid>
            </div>
