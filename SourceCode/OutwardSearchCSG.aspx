<%@ Page Language="C#" AutoEventWireup="true" Codebehind="OutwardSearchCSG.aspx.cs"
    Inherits="EFTN.OutwardSearchCSG" MaintainScrollPositionOnPostback="true" %>

<%@ Register Src="modules/footer.ascx" TagName="footer" TagPrefix="uc2" %>
<%@ Register Src="modules/CSGReportViewerHeader.ascx" TagName="Header" TagPrefix="uc1" %>
...
//    function BindReceivingBank()
//    {
//        var myReceivingBank = 'ddListReceivingBank';
//        var myTargetBank = 'txtBankName';
//        document.getElementById(myTargetBank).value = document.getElementById(myReceivingBank).Text;
//    }
//    
//    function BindRoutingNo()
//    {
//	    var myRoutNo = 'txtRoutingNo';
//		var myTargetRoutNo = 'txtReceivingBankRoutingNo'
//        document.getElementById(myTargetRoutNo).value = document.getElementById(myRoutNo).value;
//    }
...
<body class="wrap" id="content">
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div width="900px">
                <div class="boxmodule" style="padding-top: 10px; width: 650px; margin-top: 10px;
                ...
                <div class="boxmodule" style="padding-top: 10px; width: 550px; margin-top: 10px;
                    height: 100px; margin-bottom: 20px;">
                    <table>
                        <tr>
                            <td class="NormalBold">
                                Receiving Bank Name:</td>
                            <td>
                            ...
                            <asp:DataGrid ID="dtgReturnRecord" runat="Server" Width="600" BorderWidth="0px" GridLines="None"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="Dishonor">
                                        <ItemTemplate>
                                            <a href="OutwardSearch.aspx?outwardSearchReturnID=<%#DataBinder.Eval(Container.DataItem, "ReturnID")%>">
                                                Dishonor</a>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                            ...
                            <asp:DataGrid ID="dtgNOCRecord" runat="Server" Width="600" BorderWidth="0px" GridLines="None"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="RNOC">
                                        <ItemTemplate>
                                            <a href="OutwardSearch.aspx?outwardSearchNOCID=<%#DataBinder.Eval(Container.DataItem, "NOCID")%>">
                                                RNOC</a>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:BoundColumn DataField="OrgTraceNumber" HeaderText="OrgTraceNumber">
            ...
            <div style="overflow: scroll">
                <table>
                    <tr>
                        <td width="100" style="height: 221px">
                        </td>
                        <td class="NormalBold" align="center" colspan="2" style="height: 221px">
                            <asp:DataGrid ID="dtgOutwardSearch" runat="Server" Width="600" BorderWidth="0px"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn>
                                        <ItemTemplate>
                                            <a href="OutwardSearch.aspx?outwardSearchTraceNumber=<%#DataBinder.Eval(Container.DataItem, "TraceNumber")%>">
                                                Return/NOC Record</a>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
