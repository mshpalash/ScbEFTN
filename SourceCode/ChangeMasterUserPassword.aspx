<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangeMasterUserPassword.aspx.cs"Inherits="EFTN.ChangeMasterUserPassword" %>

<%@ Register Src="modules/footer.ascx" TagName="footer" TagPrefix="uc2" %>
<%@ Register Src="modules/SuperAdminHeader.ascx" TagName="CIBHeader" TagPrefix="uc1" %>
...
<%--        <uc1:CIBHeader ID="CIBHeader1" runat="server" />--%>
