<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StandingOrderTransactionEdit.aspx.cs" Inherits="EFTN.StandingOrderTransactionEdit" %>
                        ...
                        <td>
                            <table border="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtReceiverName" runat="server" Width="150px" MaxLength="22" onkeypress="return onlyEFTSpecialCharacter();" OnKeyUp="return makeUppercase(this.name);" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddListTransactionFrequency" runat="server" Enabled="false">
                            ...
                            <table>
                                <tr>
                                    <td align="center">
                                        <asp:Button ID="btnSave" Width="100px" CssClass="inputlt" runat="server"
                                            Text="Save"
                                            OnClientClick="return validateDataField()" OnClick="btnSave_Click" /><br />
                                    </td>
                                    <td>
