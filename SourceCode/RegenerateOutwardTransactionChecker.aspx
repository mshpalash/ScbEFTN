<%@ Page Language="C#" AutoEventWireup="true" Codebehind="RegenerateOutwardTransactionChecker.aspx.cs"
    Inherits="EFTN.RegenerateOutwardTransactionChecker" %>
...
<head id="Head1" runat="server">
    <title>ReGenerate Outward Transaction</title>
    ...
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div class="Head" align="center">
                Re-Generate Outward Transaction</div> 
            <div>
                ...
                <div align="center" id="AvailDiv" runat="server" style="position: relative; overflow: auto;
                    ...
                    <asp:DataGrid ID="dtgRegenerateOutward" AlternatingItemStyle-BackColor="lightyellow" AutoGenerateColumns="false"
                ...
                <div align="center" runat="server" style="position: relative; overflow: auto;
                    width: 900px; margin-top: 15px; height: 50px;">
                    <table>
                        <tr>
                            <td>
