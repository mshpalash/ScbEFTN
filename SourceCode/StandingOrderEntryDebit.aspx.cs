...
namespace EFTN
{
    public partial class StandingOrderEntryDebit : System.Web.UI.Page
    {
        ...
        private void InsertTransaction()
        {
            ...
            {
                lblMsg.Text = "Standing order start date can not be earlier than today";
                return;
            }
            ...
            standingOrderBatchID = edrDB.InsertStandingOrderForSCBDebit(dfiAccNo,
                    accNo,
