<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InwardTransactionRejectedByChecker.aspx.cs"
    Inherits="EFTN.InwardTransactionRejectedByChecker" %>
                                    ...
                                    <td colspan="3">
                                        <div id="AvailDiv" runat="server" style="overflow: scroll;">
                                            <asp:DataGrid ID="dtgInwardTransactionMaker" AlternatingItemStyle-BackColor="lightyellow"
                                                ...
                                                OnItemCommand="dtgInwardTransactionMaker_ItemCommand">
                                                <Columns>
