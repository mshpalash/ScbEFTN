<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MakerCheckerLisitingReport.aspx.cs" Inherits="EFTN.MakerCheckerLisitingReport" %>
    ...
    <form id="form2" method="post" runat="server">
        <div class="maincontent">
            ...
            <div class="Head" align="center">
              Maker Checker Listing Report</div>
            <div>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddListReportType" runat="server">
                                <asp:ListItem Value="1" Text="Outward Transaction" Selected="True"></asp:ListItem>
                                <asp:ListItem Value="2" Text="Outward Return"></asp:ListItem>
                                <asp:ListItem Value="3" Text="Outward NOC"></asp:ListItem>
                                <asp:ListItem Value="4" Text="Outward RNOC"></asp:ListItem>
                                <asp:ListItem Value="5" Text="Outward Dishonor"></asp:ListItem>
                                <asp:ListItem Value="6" Text="Outward Contested"></asp:ListItem>
                                <asp:ListItem Value="7" Text="Inward Transaction Approve"></asp:ListItem>
                                <asp:ListItem Value="8" Text="Inward Return"></asp:ListItem>
                                <asp:ListItem Value="9" Text="Inward NOC"></asp:ListItem>
                                <asp:ListItem Value="10" Text="Inward RNOC"></asp:ListItem>
                                <asp:ListItem Value="11" Text="Inward Dishonor"></asp:ListItem>
                                <asp:ListItem Value="12" Text="Inward Contested"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
            ...
            <div style="overflow: scroll; width: 940px; height: 500px; margin-left: 100px; margin-left: 15px">
                <asp:Panel ID="pnlReportSettlement" runat="server" Height="400px" Width="900px">
                    <asp:DataGrid ID="dtgReportMakerCheckerListing" runat="Server" AlternatingItemStyle-BackColor="lightyellow"
                        ...
                        ItemStyle-CssClass="NormalSmall" ShowFooter="true" PagerStyle-Position="Top" PageSize="500" AllowPaging="True" AllowSorting="True" OnPageIndexChanged="dtgReportMakerCheckerListing_PageIndexChanged" OnSortCommand="dtgReportMakerCheckerListing_SortCommand">
                        <Columns>
                            <asp:TemplateColumn HeaderText="SL.">
                                <ItemTemplate>
                                    <%#(dtgReportMakerCheckerListing.PageSize * dtgReportMakerCheckerListing.CurrentPageIndex) + Container.ItemIndex + 1%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:BoundColumn DataField="EntryDate" HeaderText="Register Date"  SortExpression = "EntryDate">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                             <asp:BoundColumn DataField="UserName"  HeaderText="Maker"  SortExpression = "UserName" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="UserNameChecker" HeaderText="Checker"  SortExpression = "UserNameChecker">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="AccountNo" HeaderText="SenderAccountNo"  SortExpression = "AccountNo">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="BankName" HeaderText="ReceiverBankName"  SortExpression = "BankName">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
