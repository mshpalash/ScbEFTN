<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CorporateUploadDebit.aspx.cs"
    Inherits="EFTN.CorporateUploadDebit" MaintainScrollPositionOnPostback="true" %>
...
<body class="wrap" id="content">
    ...
    <form id="form2" method="post" runat="server">
        <div class="maincontent">
            ...
            <div class="Head" align="Center" style="background-color: red">
                <h1 style="color: white">Upload Corporate data for DEBIT</h1>
            </div>
                        ...
                        <td>
                                ...
                                <tr>
                                    ...
                                    <td class="NormalBold">
                                        <asp:RadioButtonList ID="rdoBtnTransactionType" RepeatDirection="Horizontal" runat="server" Visible="false">
                                            ...
                                            <asp:ListItem Value="Debit" Selected="True">Debit</asp:ListItem>
                                        </asp:RadioButtonList>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div style="overflow: scroll; height: 450px; width: 900px">
                                <asp:DataGrid ID="dtgXcelUpload" runat="Server" Width="600px" BorderWidth="0px"
                                    ...
                                    <FooterStyle CssClass="GrayBackWhiteFont" BackColor="#FFFFCC" ForeColor="#330099" />
                                    <PagerStyle BackColor="#FFFFCC" ForeColor="#330099" HorizontalAlign="Center" Mode="NumericPages" />
                                    <ItemStyle BackColor="White" CssClass="NormalSmall" ForeColor="#330099" />
                                    <HeaderStyle CssClass="GrayBackWhiteFont" ForeColor="#FFFFCC" BackColor="#ff0000" Font-Bold="True" />
