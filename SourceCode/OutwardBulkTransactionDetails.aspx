<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutwardBulkTransactionDetails.aspx.cs" Inherits="EFTN.OutwardBulkTransactionDetails"%>
...
<body class="wrap" id="content">
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <br />
            <div align="center">
                <a href="OutwardBulkFromReport.aspx" class="CommandButton">Report Of Bulk Transaction</a>
            </div>
            <div class="Head" align="center">
                Details of Bulk Transaction </div>
            <br />
            <div align="center">
                <asp:Button ID="ExpotToPdfBtn" runat="server" Text="Export to PDF" OnClick="ExpotToPdfBtn_Click"/>
                <asp:DataGrid ID="dtgBulkTransactionDetails" runat="Server" Width="600" BorderWidth="0px"
                    GridLines="None" AutoGenerateColumns="False" CellPadding="5" CellSpacing="1"
                    ItemStyle-CssClass="NormalSmall" FooterStyle-CssClass="GrayBackWhiteFont" HeaderStyle-CssClass="GrayBackWhiteFontFixedHeader"
                    ItemStyle-BackColor="#dee9fc" AlternatingItemStyle-BackColor="#ffffff" AllowPaging="True"
                    PageSize="50" ShowFooter="true" OnPageIndexChanged="dtgBulkTransactionDetails_PageIndexChanged">
                    <Columns>
                        <asp:TemplateColumn HeaderText="SL.">
                            <ItemTemplate>
                                <%#(dtgBulkTransactionDetails.PageSize * dtgBulkTransactionDetails.CurrentPageIndex) + Container.ItemIndex + 1%>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:BoundColumn DataField="EntryDateTransactionSent" HeaderText="EntryDateTransactionSent">
