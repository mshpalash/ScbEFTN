<%@ Page Language="C#" AutoEventWireup="true" Codebehind="OutwardDebitSummaryReport.aspx.cs" Inherits="EFTN.OutwardDebitSummaryReport" %>
...
<head id="Head1" runat="server">
    <title>Outward Debit Summary Report</title>
    ...
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <asp:Label ID="lblStatusReport" CssClass="NormalRed" runat="Server"></asp:Label><br />
                <asp:DataGrid ID="dtgOutwardDebitSummaryReport" runat="Server" Width="600" BorderWidth="0px" GridLines="None"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="ZoneName" HeaderText="ZoneName" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="DrItem" HeaderText="DrItem" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="DrAmt" DataFormatString="{0:N}" HeaderText="DrAmt" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="RetDrItem" HeaderText="RetDrItem" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="RetDrAmt" DataFormatString="{0:N}" HeaderText="RetDrAmt" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" />
