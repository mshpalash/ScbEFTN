<%@ Page Language="C#" AutoEventWireup="true" Codebehind="EFTChargeManagement.aspx.cs" Inherits="EFTN.EFTChargeManagement" %>
    ...
    <form id="form1" runat="server">
        <div class="maincontent" style="height:550px">
            ...
            <table  cellspacing="25px" cellpadding="25px">
                <tr> 
                    <td align="center"><a href="ChargeAccountManagement.aspx" class="CommandButton">Accounts Charge Management</a></td>
                    <td align="center"><a href="MasterCodeManagement.aspx" class="CommandButton">Master Code Management</a></td>
                    <td align="center"><a href="SegmentCodeManagement.aspx" class="CommandButton">Segment Code Management</a></td>
                    <td align="center"><a href="ProductCodeManagement.aspx" class="CommandButton">Product Code Management</a></td>
                </tr>
                <tr>
                    <td align="center"><a href="MICRAccountManagementForCharge.aspx" class="CommandButton">Account Management</a></td>
                </tr>
            </table>
