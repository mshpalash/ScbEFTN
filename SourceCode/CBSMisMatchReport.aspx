<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CBSMisMatchReport.aspx.cs" Inherits="EFTN.CBSMisMatchReport" %>
...
<body class="wrap" id="content">
    <form id="form2" method="post" runat="server">
        <div class="maincontent">
            ...
            <div align="center" class="boxmodule" style="padding-top: 10px; width: 960px; margin-top: 10px;
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddListMismatchReportType" runat="server">
                                <asp:ListItem Value="1" Text="Mismatch Outward Transaction" Selected="True"></asp:ListItem>
                                <asp:ListItem Value="2" Text="Mismatch Inward Transaction"></asp:ListItem>
                                <asp:ListItem Value="3" Text="Mismatch Inward Return"></asp:ListItem>
                                <asp:ListItem Value="4" Text="Mismatch Outward Batch"></asp:ListItem>
            ...
            <div style="overflow: auto; width: 940px; margin-left: 15px" id="divItemWiseMismatch" runat="server">
                <asp:Panel ID="pnlReportSettlement" runat="server" Height="400px" Width="900px">
                    <asp:DataGrid ID="dtgMismatchReport" runat="Server" AlternatingItemStyle-BackColor="lightyellow"
                        ...
                        PagerStyle-Position="Top" PageSize="10" AllowPaging="True" AllowSorting="True" 
                        OnPageIndexChanged="dtgMismatchReport_PageIndexChanged">
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="XLAccountNo" HeaderText="XLAccountNo"  SortExpression = "XLAccountNo" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="XLAmount" HeaderText="XLAmount"  SortExpression = "XLAmount" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
            ...
            <div style="width: 940px; margin-left: 15px; margin-bottom: 20px" id="divBatchWiseMismatch" runat="server">
                <table>
                    <tr>
