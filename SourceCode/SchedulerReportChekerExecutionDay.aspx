<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SchedulerReportChekerExecutionDay.aspx.cs"
    Inherits="EFTN.SchedulerReportChekerExecutionDay" MaintainScrollPositionOnPostback="true" %>
    ...
    <uc1:Header ID="Header1" runat="server" />
        ...
        <div class="boxmodule" style="padding-top:20px; width:950px; height:150px; margin-top:0px; margin-left:20px">
            <table>
                        <tr>
                            <td class="NormalBold">
                                <asp:Label ID="lblDay" runat="server" Text="Execution Date Begin"></asp:Label>
                            </td>
                            <td>
                                <table>
                                    <tr>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblEndDate" runat="server" Text="Execution Date End"></asp:Label>
                            </td>
                            <td>
                                <table>
                                    <tr>
                                            ...
                                            <asp:DataGrid ID="dtgStandingOrderBatch" runat="Server" BorderWidth="0px" GridLines="None"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="">
                                                        <ItemTemplate>
                                                            <a href="SchedulerReportTransactionListForChecker.aspx?StandingOrderBatchID=<%#DataBinder.Eval(Container.DataItem, "StandingOrderBatchID")%>">
                                                                Batch Details</a>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>     
                                                    ...
                                                    <asp:BoundColumn DataField = "SendingStatus" HeaderText="SendingStatus" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                                                </Columns>
