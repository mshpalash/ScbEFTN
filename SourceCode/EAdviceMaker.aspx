<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EAdviceMaker.aspx.cs"
    Inherits="EFTN.EAdviceMaker" %>
            ...
            <div align="center" class="boxmodule" style="padding-top: 10px; width: 960px; margin-top: 10px; height: 40px; margin-left: 5px">
                <table>
                    <tr>
                        ...
                        <td></td>
                        <td style="height: 21px">
                            <asp:DropDownList ID="ddListCriteria" runat="server">
                                <asp:ListItem Value="1">Successful</asp:ListItem>
                                <asp:ListItem Value="2">Unsuccessful</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td style="height: 46px">
                            <asp:Button ID="Transferbtn" runat="server" Text="Transfer Advices" OnClick="Transferbtn_Click" />
                        </td>
                    </tr>
                </table>
            </div>
            <div style="overflow: auto; width: 940px; margin-left: 100px; margin-left: 15px" align="center">
                    ...
                    <asp:DataGrid ID="dtgSettlementReport" runat="Server" AlternatingItemStyle-BackColor="lightyellow"
                        ...
                        <Columns>
                           <%-- <asp:TemplateColumn SortExpression="SN" HeaderText="Serial No.">
                            ...
                            <asp:TemplateColumn SortExpression="File Name" HeaderText="File Name">
                                <ItemTemplate>
                                    <%#DataBinder.Eval(Container.DataItem, "File Name")%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn SortExpression="Email ID" HeaderText="Email ID">
                                <ItemTemplate>
                                    <%#DataBinder.Eval(Container.DataItem, "Email ID")%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
