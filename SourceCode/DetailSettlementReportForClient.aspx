<%@ Page Language="C#" AutoEventWireup="true" Codebehind="DetailSettlementReportForClient.aspx.cs"
    Inherits="EFTN.DetailSettlementReportForClient" %>

<%@ Register Src="modules/footer.ascx" TagName="footer" TagPrefix="uc2" %>
<%@ Register Src="modules/ClientHeader.ascx" TagName="EFTClientHeader" TagPrefix="uc1" %>
...
<body class="wrap" id="content">
    <form id="form2" method="post" runat="server">
        <div class="maincontent">
            <uc1:EFTClientHeader ID="EFTHeader1" runat="server" />
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddListReportType" runat="server">
                                <asp:ListItem Value="1" Text="Outward Transaction (Initial Transaction)"></asp:ListItem>
                                <asp:ListItem Value="2" Text="Inward Return"></asp:ListItem>
                                <asp:ListItem Value="3" Text="Inward NOC"></asp:ListItem>
                                <asp:ListItem Value="4" Text="Inward Transaction"></asp:ListItem>
                                <asp:ListItem Value="5" Text="Outward NOC"></asp:ListItem>
                                <asp:ListItem Value="6" Text="Outward Return"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
            ...
            <div style="padding-top:20px; padding-left:220px">
                <table>
                    <tr height="20px">
                        ...
                        <td>
                            <a href="ChangeClientPassword.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','images/ChangePasswordOn.gif',1)"><img src="images/ChangePassword.gif" name="Image5" width="149" height="25" border="0" id="Image5" /></a>
