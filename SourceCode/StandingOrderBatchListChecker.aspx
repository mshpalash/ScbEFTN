<%@ Page Language="C#" AutoEventWireup="true" Codebehind="StandingOrderBatchListChecker.aspx.cs"
    Inherits="EFTN.StandingOrderBatchListChecker" MaintainScrollPositionOnPostback="true" %>
        ...
        <div class="boxmodule" style="padding-top:20px; width:950px; height:150px; margin-top:0px; margin-left:20px">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <asp:LinkButton ID="linkBtnActive" runat="server" Text="Active" 
                            CssClass="CommandButton" onclick="linkBtnActive_Click"></asp:LinkButton>
                    </td>
                    <td width="50px">
                    </td>
                    <td>
                        <asp:LinkButton ID="linkBtnInactive" runat="server" Text="Inactive" 
                            CssClass="CommandButton" onclick="linkBtnInactive_Click"></asp:LinkButton>
                    </td>
                    <td width="50px">
                    </td>
                    <td width="50px">
                ...
                <tr>
                    ...
                    <td>
                        <asp:LinkButton ID="linkBtnReject" runat="server" Text="Reject" 
                            CssClass="CommandButton" OnClick="linkBtnReject_Click"></asp:LinkButton>
                    </td>
                </tr>
            </table>
        </div>
            <div align="center">
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnGeneratePDF" runat="server" Text="PDF" OnClick="btnGeneratePDF_Click"/>
                            </td>
                        </tr>
                    </table>
            </div>
                                            ...
                                            <asp:DataGrid ID="dtgStandingOrderBatch" runat="Server" BorderWidth="0px" GridLines="None"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="">
                                                        <ItemTemplate>
                                                            <a href="StandingOrderTransactionListForChecker.aspx?StandingOrderBatchID=<%#DataBinder.Eval(Container.DataItem, "StandingOrderBatchID")%>">
                                                                Batch Details</a>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>    
