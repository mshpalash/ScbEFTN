<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlatFilesForTransactionReceived.aspx.cs"
    Inherits="EFTN.FlatFilesForTransactionReceived" %>
    ...
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div class="Head" align="center">
               Received Transactions Export to CBS
            </div>
            <div>
            ...
            <div align="center" class="boxmodule" style="padding-top: 10px; width: 800px; margin-top: 10px; height: 40px; margin-left: 100px">
                <table>
                    <tr>
                        ...
                        <td width="10"></td>
                        <td>
                            <asp:DropDownList ID="ddListHold" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddListHold_SelectedIndexChanged">
                ...
                <asp:DataGrid ID="dtgTransactionSentToOwnBank" runat="Server" Width="600" BorderWidth="0px"
                    ...
                    <Columns>
                        <asp:TemplateColumn HeaderText="SL.">
                            <ItemTemplate>
                                <%#(dtgTransactionSentToOwnBank.PageSize * dtgTransactionSentToOwnBank.CurrentPageIndex) + Container.ItemIndex + 1%>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:BoundColumn DataField="valueDate" HeaderText="valueDate" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="Narration1" HeaderText="Narration" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" />                        
                    </Columns>
                </asp:DataGrid>
            </div>
