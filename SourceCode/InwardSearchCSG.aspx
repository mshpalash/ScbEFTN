<%@ Page Language="C#" AutoEventWireup="true" Codebehind="InwardSearchCSG.aspx.cs" Inherits="EFTN.InwardSearchCSG" %>
                            ...
                            <asp:DataGrid ID="dtgReturnRecord" runat="Server" Width="600" BorderWidth="0px" GridLines="None"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="Dishonor">
                                        <ItemTemplate>
                                            <a href="InwardSearch.aspx?inwardSearchReturnID=<%#DataBinder.Eval(Container.DataItem, "ReturnID")%>">
                                                Dishonor</a>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                            ...
                            <asp:DataGrid ID="dtgNOCRecord" runat="Server" Width="600" BorderWidth="0px" GridLines="None"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="RNOC">
                                        <ItemTemplate>
                                            <a href="InwardSearch.aspx?inwardSearchNOCID=<%#DataBinder.Eval(Container.DataItem, "NOCID")%>">
                                                RNOC</a>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                        ...
                        <td class="NormalBold" align="center" colspan="2">
                            <asp:DataGrid ID="dtgInwardSearch" runat="Server" Width="600" BorderWidth="0px" GridLines="None"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn>
                                        <ItemTemplate>
                                            <a href="InwardSearch.aspx?inwardSearchEDRID=<%#DataBinder.Eval(Container.DataItem, "EDRID")%>">
                                                Return/NOC Record</a>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
