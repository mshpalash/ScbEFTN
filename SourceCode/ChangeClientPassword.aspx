<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ChangeClientPassword.aspx.cs"
    Inherits="EFTN.ChangeClientPassword" %>
    ...
    <form id="form2" method="post" runat="server">
        <div class="maincontent" style="height:550px">
            ...
            <div align="center" class="boxmodule" style="padding-top: 10px; width: 200px; margin-top: 10px;
                height: 40px; margin-left: 400px; padding-left: 15px">
                <table>
                    <tr align="left">
                        <td>
                        </td>
