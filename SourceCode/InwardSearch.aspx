<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InwardSearch.aspx.cs" Inherits="EFTN.InwardSearch" %>
...
<body class="wrap" id="content">
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <br />
            <div class="boxmodule" style="padding-top: 10px; width: 700px; margin-top: 10px; height: 520px; margin-bottom: 20px;">
                <table width="700px">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="center" class="NormalBold">
                            <asp:RadioButtonList ID="rdoBtnSearchType" RepeatDirection="Horizontal" runat="server">
                                ...
                                <asp:ListItem Value="3">Outward NOC</asp:ListItem>
                            </asp:RadioButtonList>
            ...
            <div class="boxmodule" style="padding-top: 10px; width: 880px; margin-top: 10px; height: 100px; margin-bottom: 20px;">
                <table>
                    <tr>
                        <td class="NormalBold">Bank Name:</td>
                        <td>
            ...
            <div align="center" class="boxmodule" style="padding-top: 10px; width: 880px; margin-top: 10px; height: 60px;">
                <table>
                    <tr>
                        <td>
                            ...
                            <asp:DataGrid ID="dtgReturnRecord" runat="Server" Width="600" BorderWidth="0px" GridLines="None"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="Dishonor">
                                        <ItemTemplate>
                                            <a href="InwardSearch.aspx?inwardSearchReturnID=<%#DataBinder.Eval(Container.DataItem, "ReturnID")%>">Dishonor</a>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                            ...
                            <asp:DataGrid ID="dtgNOCRecord" runat="Server" Width="600" BorderWidth="0px" GridLines="None"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="RNOC">
                                        <ItemTemplate>
                                            <a href="InwardSearch.aspx?inwardSearchNOCID=<%#DataBinder.Eval(Container.DataItem, "NOCID")%>">RNOC</a>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                        ...
                        <td class="NormalBold" align="center" colspan="2">
                            <asp:DataGrid ID="dtgInwardSearch" runat="Server" Width="600" BorderWidth="0px" GridLines="None"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn>
                                        <ItemTemplate>
                                            <a href="InwardSearch.aspx?inwardSearchEDRID=<%#DataBinder.Eval(Container.DataItem, "EDRID")%>">Return/NOC Record</a>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
