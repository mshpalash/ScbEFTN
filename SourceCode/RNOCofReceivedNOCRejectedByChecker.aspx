<%@ Page Language="C#" AutoEventWireup="true" Codebehind="RNOCofReceivedNOCRejectedByChecker.aspx.cs"
    Inherits="EFTN.RNOCofReceivedNOCRejectedByChecker" %>
...
<body class="wrap" id="content">
    ...
    <uc1:Header ID="Header1" runat="server" />
        <div class="Head" align="center">
            (NOC) Rejected by checker which were RNOC by maker</div>
        <div style="overflow:scroll">
            <table>
                <tr>
                    <td colspan="3">
                        <asp:DataGrid ID="dtgEFTRNOCOfReceivedNOCRejectedList" AlternatingItemStyle-BackColor="lightyellow"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="RefusedCORCode" HeaderText="RefusedCORCode" ItemStyle-Wrap="False"
                                    HeaderStyle-Wrap="False" />
                                <asp:BoundColumn DataField="RefusedCorrectedData" HeaderText="RefusedCorrectedData"
        ...
        <div>
            <table>
                <tr>
                    <td>
                        <asp:Label ID="lblRNOCMsg" CssClass="NormalBold" runat="server" Text="Correct the RNOC"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td colspan="3">
                        <asp:LinkButton ID="lnkBtnNOC" runat="server" Text="Cancel RNOC and Approve as NOC" CssClass="CommandButton" OnClick="lnkBtnNOC_Click" OnClientClick="return confirm('Are you sure you want to save?')"></asp:LinkButton>
                    </td>
                </tr>
