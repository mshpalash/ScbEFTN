<%@ Page Language="C#" AutoEventWireup="true" Codebehind="HoldStatusReport.aspx.cs"
    Inherits="EFTN.HoldStatusReport" %>
...
<head id="Head1" runat="server">
    <title>Hold Status Report</title>
    ...
    <form id="form1" runat="server">
        <div class="maincontent">
           ...
           <div>
            ...
            <div id="AvailDiv" runat="server" align="center" class="boxmodule" style="padding-top: 10px;
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnExpotToCSV" runat="server" Text="Export to CSV" 
            ...
            <div style="overflow: auto;width: 750px; margin-left:200px">                
            <asp:Label ID="lblStatusReport" CssClass="NormalRed" runat="Server"></asp:Label><br />
                <asp:DataGrid ID="dtgStatusReport" runat="Server" Width="600" BorderWidth="0px" GridLines="None"
                    ...
                    <Columns>
                        <asp:BoundColumn DataField="InmakerItem" HeaderText="Inmaker Item" ItemStyle-Wrap="True"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="InmakerAmt" HeaderText="Inmaker Amt" ItemStyle-Wrap="true"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="InmakerApprovedItem" HeaderText="Inmaker Approved Item" ItemStyle-Wrap="true"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="InmakerApprovedAmt" HeaderText="Inmaker Approved Amt" ItemStyle-Wrap="true"
                            HeaderStyle-Wrap="False" />

                        <asp:BoundColumn DataField="InmakerRejectedItem" HeaderText="Inmaker Rejected Item" ItemStyle-Wrap="true"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="InmakerRejectedAmt" HeaderText="Inmaker Rejected Amt" ItemStyle-Wrap="true"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="InmakerHoldItem" HeaderText="Inmaker Hold Item" ItemStyle-Wrap="true"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="InmakerHoldAmt" HeaderText="Inmaker Hold Amt" ItemStyle-Wrap="true"
                            HeaderStyle-Wrap="False" />
                    </Columns>
                </asp:DataGrid>
            </div>
