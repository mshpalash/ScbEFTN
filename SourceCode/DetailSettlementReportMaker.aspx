<%@ Page Language="C#" AutoEventWireup="true" Codebehind="DetailSettlementReportMaker.aspx.cs"
    Inherits="EFTN.DetailSettlementReportMaker" %>
    ...
    <form id="form2" method="post" runat="server">
        <div class="maincontent">
           ...
           <div>
            ...
            <div align="center" class="boxmodule" style="padding-top:10px; width:980px; margin-top:10px; height:55px; margin-left:5px">
             <table>
                    <tr>
                        <td class="NormalBold">
                        ...
                        <td>
                            <asp:DropDownList ID="ddListReportType" runat="server">
                                <asp:ListItem Value="1" Text="Outward Transaction (Initial Transaction)" Selected="True"></asp:ListItem>
                                ...
                                <asp:ListItem Value="101" Text="Outward Transaction (Initial Transaction) " ></asp:ListItem>
                                ...
                                <asp:ListItem Value="109" Text="Outward Dishonor"></asp:ListItem>
                                ...
                                <asp:ListItem Value="110" Text="Branchwise Transaction Received All (PDF Only)"></asp:ListItem>
                                ...
                                <asp:ListItem Value="201" Text="Outward Transaction (Initial Transaction) " ></asp:ListItem>
                                ...
                                <asp:ListItem Value="209" Text="Outward Dishonor"></asp:ListItem>
                                ...
                                <asp:ListItem Value="210" Text="Branchwise Transaction Received All (PDF Only)"></asp:ListItem>
            ...
            <div style="overflow: auto">
                <asp:Panel ID="pnlReportSettlement" runat="server" Height="400px" Width="900px">
                    <asp:DataGrid ID="dtgSettlementReport" runat="Server" AlternatingItemStyle-BackColor="lightyellow"
                        ...
                        ItemStyle-CssClass="NormalSmall" ShowFooter="true" PagerStyle-Position="Top" AllowPaging="True" OnPageIndexChanged="dtgSettlementReport_PageIndexChanged" PageSize="50" AllowSorting="True" OnSortCommand="dtgSettlementReport_SortCommand">
                        <Columns>
