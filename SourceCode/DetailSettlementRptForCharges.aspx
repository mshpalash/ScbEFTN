<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetailSettlementRptForCharges.aspx.cs" Inherits="EFTN.DetailSettlementRptForCharges" %>
    ...
    <form id="form2" method="post" runat="server">
        <div class="maincontent">
            ...
            <div class="Head" align="center">
                Detail Settlement Report for Charges</div>
            <div>
                    ...
                    <asp:DataGrid ID="dtgSettlementReport" runat="Server" AlternatingItemStyle-BackColor="lightyellow"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="TraceNumber" HeaderText="TraceNumber"  SortExpression = "TraceNumber" >
                                ...
                                <asp:BoundColumn DataField="AccountNo" HeaderText="Sender AccountNo"  SortExpression = "AccountNo" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="BankCharge" DataFormatString="{0:N}" HeaderText="Bank Charge on Customer"  SortExpression = "BankCharge" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            
                               <asp:BoundColumn DataField="BankChargeVAT" DataFormatString="{0:N}" HeaderText="Bank Charge VAT on Customer"  SortExpression = "BankChargeVAT" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            
                                                        
                               <asp:BoundColumn DataField="HSBCBankCommissionContribution" DataFormatString="{0:N}" HeaderText="Bank Contribution on Customer"  SortExpression = "HSBCBankCommissionContribution" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            
                                                        
                               <asp:BoundColumn DataField="HSBCBankVATContribution" DataFormatString="{0:N}" HeaderText="Bank Contribution VAT on Customer"  SortExpression = "HSBCBankVATContribution" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            
                             <asp:BoundColumn DataField="TotalCharge" DataFormatString="{0:N}" HeaderText="Total Charge"  SortExpression = "TotalCharge" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            
                            <asp:BoundColumn DataField="HSBCBankComContACNo" HeaderText="HSBCBankComContACNo"  SortExpression = "HSBCBankComContACNo" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="HSBCBankVATContACNo" HeaderText="HSBCBankVATContACNo"  SortExpression = "HSBCBankVATContACNo" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="HSBCBulkEntry" HeaderText="HSBCBulkEntry"  SortExpression = "HSBCBulkEntry" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>      
