<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExportContestedDishonorXML.aspx.cs" Inherits="EFTN.ExportContestedDishonorXML" %>
...
<body class="wrap" id="content">
    ...
    <uc1:Header ID="Header1" runat="server" />
        <div class="Head" align="center">
            Export Contested Dishonor XML</div>
                <div id="AvailDiv" runat="server" style="position: relative; overflow: scroll;
                    height: 200px;">
                    <table>
                        <tr>
                         
                           <td class="NormalBold" align="center" colspan="2">
                                <asp:DataGrid ID="dtgBatchContestedDishonor" runat="Server" Width="600" BorderWidth="0px"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="EnvelopID" HeaderText="EnvelopID" ItemStyle-Wrap="False" HeaderStyle-Wrap="False" />
