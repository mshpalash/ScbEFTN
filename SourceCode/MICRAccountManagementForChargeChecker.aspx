<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MICRAccountManagementForChargeChecker.aspx.cs" Inherits="FloraSoft.MICRAccountManagementForChargeChecker" %>
...
<head id="Head1" runat="server">
    <title>Charge Account Management</title>
...
<body class="wrap" id="content">
    ...
    <uc1:Header ID="Header" runat="server" />
        <div class="Head" align="center">Accounts Charge Management</div>
        <div align="center">
            <table>
                <tr height="10px">
                    <td>
        ...
        <div align="center" class="boxmodule" style="width:940px;margin-left:20px; padding-top:15px; padding-left:15px; min-height:400px; overflow: scroll; margin-bottom:15px; margin-top:20px">
            ...
            <asp:datagrid Id="MyDataGrid2"
                ...
                <Columns>
                    <asp:TemplateColumn HeaderText="AccountID" HeaderStyle-Wrap="false"  ItemStyle-Wrap="false"  ItemStyle-HorizontalAlign="Left" FooterStyle-CssClass="red" HeaderStyle-Width="60px" FooterStyle-Width="120px" ItemStyle-Width="120px" >
                        <ItemTemplate>
                            <%#DataBinder.Eval(Container.DataItem, "AccountID")%>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:TemplateColumn HeaderText="Original Account No." HeaderStyle-Wrap="false"  ItemStyle-Wrap="false"  ItemStyle-HorizontalAlign="Left" FooterStyle-CssClass="red" HeaderStyle-Width="60px" FooterStyle-Width="120px" ItemStyle-Width="120px" >
                        <ItemTemplate>
                            <%#DataBinder.Eval(Container.DataItem, "ACCOUNT")%>
                        </ItemTemplate>
                        <EditItemTemplate>
                             <asp:TextBox ID="txtACCOUNT" runat="server" Width="120px" 
                             Text='<%#DataBinder.Eval(Container.DataItem,"ACCOUNT") %>'></asp:TextBox>
                        </EditItemTemplate>
                         <FooterTemplate>
                                <asp:TextBox ID="addACCOUNT" Width="120"  Runat="Server" MaxLength="20" />
                    ...
                    <asp:TemplateColumn HeaderText="Charge Deduct Account No." HeaderStyle-Wrap="false"  ItemStyle-Wrap="false"  ItemStyle-HorizontalAlign="Left" FooterStyle-CssClass="red" HeaderStyle-Width="60px" FooterStyle-Width="120px" ItemStyle-Width="120px" >
                        <ItemTemplate>
                            <%#DataBinder.Eval(Container.DataItem, "ChargeAccount")%>
                        </ItemTemplate>
                        <EditItemTemplate>
                             <asp:TextBox ID="txtChargeAccount" runat="server" Width="120px" 
                             Text='<%#DataBinder.Eval(Container.DataItem,"ChargeAccount") %>'></asp:TextBox>
                        </EditItemTemplate>
                         <FooterTemplate>
                                <asp:TextBox ID="addChargeAccount" Width="120"  Runat="Server" MaxLength="20" />
                                <asp:RequiredFieldValidator 
                                id="RequiredFieldValidatoraddChargeAccount" 
                                CssClass="NormalRed" runat="server" 
                                ControlToValidate="addChargeAccount"
                                ErrorMessage="*" Display="dynamic">
                                </asp:RequiredFieldValidator>
                          </FooterTemplate>
                    </asp:TemplateColumn>
