<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SegmentCodeManagementChecker.aspx.cs" Inherits="FloraSoft.SegmentCodeManagementChecker" %>
...
<body class="wrap" id="content">
    ...
    <uc1:Header ID="Header" runat="server" />
        <div class="Head" align="center">Segment Code Management</div>
        <div align="center">
            <table>
                <tr height="10px">
                    <td>
        ...
        <div align="center" class="boxmodule" style="width:940px;margin-left:20px; padding-top:15px; padding-left:15px; min-height:400px; overflow: scroll; margin-bottom:15px; margin-top:20px">
            ...
            <asp:datagrid Id="MyDataGrid2"
                ...
                autogeneratecolumns="false"  DataKeyField="ChargeSegmentID" 
                gridlines="None" borderwidth="0px" ShowFooter="true"  Height="0px"
                OnItemCommand="MyDataGrid2_ItemCommand">
                <Columns>
                    <asp:TemplateColumn HeaderText="SegmentID" HeaderStyle-Wrap="false"  ItemStyle-Wrap="false"  ItemStyle-HorizontalAlign="Left" FooterStyle-CssClass="red" HeaderStyle-Width="60px" FooterStyle-Width="120px" ItemStyle-Width="120px" >
                        <ItemTemplate>
                            <%#DataBinder.Eval(Container.DataItem, "ChargeSegmentID")%>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:TemplateColumn HeaderText="SEGMENT" HeaderStyle-Wrap="false"  ItemStyle-Wrap="false"  ItemStyle-HorizontalAlign="Left" FooterStyle-CssClass="red" HeaderStyle-Width="60px" FooterStyle-Width="120px" ItemStyle-Width="120px" >
                        <ItemTemplate>
                            <%#DataBinder.Eval(Container.DataItem, "SEGMENT")%>
                        </ItemTemplate>
                        <EditItemTemplate>
                             <asp:TextBox ID="txtACCOUNT" runat="server" Width="120px" 
                             Text='<%#DataBinder.Eval(Container.DataItem,"SEGMENT") %>'></asp:TextBox>
                        </EditItemTemplate>
                         <FooterTemplate>
                                <asp:TextBox ID="addACCOUNT" Width="120"  Runat="Server" MaxLength="2" />
