    <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutwardSearch.aspx.cs"
    Inherits="EFTN.OutwardSearch" MaintainScrollPositionOnPostback="true" %>
...
<body class="wrap" id="content">
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div width="900px">
                <div class="boxmodule" style="padding-top: 10px; width: 650px; margin-top: 10px; height: 520px; margin-bottom: 20px;">
                    <table width="700px">
                        <tr>
                            ...
                            <td valign="top" class="NormalBold">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtAccountNo" runat="server" Width="130px" MaxLength="17" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                            ...
                            <asp:DataGrid ID="dtgReturnRecord" runat="Server" Width="600" BorderWidth="0px" GridLines="None"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="Dishonor">
                                        <ItemTemplate>
                                            <a href="OutwardSearch.aspx?outwardSearchReturnID=<%#DataBinder.Eval(Container.DataItem, "ReturnID")%>">Dishonor</a>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                            ...
                            <asp:DataGrid ID="dtgNOCRecord" runat="Server" Width="600" BorderWidth="0px" GridLines="None"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="RNOC">
                                        <ItemTemplate>
                                            <a href="OutwardSearch.aspx?outwardSearchNOCID=<%#DataBinder.Eval(Container.DataItem, "NOCID")%>">RNOC</a>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:BoundColumn DataField="OrgTraceNumber" HeaderText="OrgTraceNumber">
                                        <HeaderStyle Wrap="False" />
                        ...
                        <td class="NormalBold" align="center" colspan="2" style="height: 221px">
                            <asp:DataGrid ID="dtgOutwardSearch" runat="Server" Width="600" BorderWidth="0px"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn>
                                        <ItemTemplate>
                                            <a href="OutwardSearch.aspx?outwardSearchTraceNumber=<%#DataBinder.Eval(Container.DataItem, "TraceNumber")%>">Return/NOC Record</a>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
