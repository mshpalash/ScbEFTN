<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InwardReturnApprovedByMaker.aspx.cs"
    Inherits="EFTN.InwardReturnApprovedByMaker" MaintainScrollPositionOnPostback="true" %>
    ...
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div style="overflow: scroll">
                <table>
                    <tr>
                        <td class="NormalBold">Received Return Approved by Maker:
                        </td>
                    </tr>
                    <tr>
                        <td>
                                        ...
                                        <asp:DataGrid ID="dtgApprovedReturnChecker" AlternatingItemStyle-BackColor="lightyellow"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderText="Session">
                                                    <ItemTemplate>
                                                        <%#string.Format("{0:N}", DataBinder.Eval(Container.DataItem, "SessionID"))%>
                                                    </ItemTemplate>
                                                </asp:TemplateColumn>
            ...
            <div>
                <table>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <asp:Label ID="lblMsgApproved" runat="server" Text="Enter reject reason" CssClass="NormalRed"
                                Visible="false" />
                        </td>
                    </tr>
                </table>
