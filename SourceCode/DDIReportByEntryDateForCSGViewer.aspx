<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DDIReportByEntryDateForCSGViewer.aspx.cs"
    Inherits="EFTN.DDIReportByEntryDateForCSGViewer" %>

<%@ Register Src="modules/footer.ascx" TagName="footer" TagPrefix="uc2" %>
<%@ Register Src="modules/CSGReportViewerHeader.ascx" TagName="EFTCheckerHeader" TagPrefix="uc1" %>
    ...
    <form id="form2" method="post" runat="server">
        <div class="maincontent">
            ...
            <div class="Head" align="center">
                DDI Transaction Report
            </div>
            <div align="center" class="boxmodule" style="padding-top: 10px; width: 960px; margin-top: 10px; height: 80px; margin-left: 5px">
                <table>
                    <tr>
                        <td class="NormalBold">
                            <asp:Label ID="lblDay" runat="server" Text="Transaction Entry Date Begin"></asp:Label>
                        </td>
                        <td>
                            <table>
                                <tr>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblEndDate" runat="server" Text="Transaction Entry Date End"></asp:Label>
                        </td>
                        <td>
                            <table>
                                <tr>
                        ...
                        <td style="height: 46px">
                            <asp:DropDownList ID="ddListReportType" runat="server">
                                <asp:ListItem Value="7" Text="Returned by Other Bank after 2 Working Days" Selected="True"></asp:ListItem>
                                <asp:ListItem Value="5" Text="Returned by Other Bank and Flatfile Generated"></asp:ListItem>
                                <asp:ListItem Value="6" Text="Outward Sent and Flatfile Generated"></asp:ListItem>
                                <asp:ListItem Value="4" Text="Transaction Sent to Other Bank"></asp:ListItem>
                                <asp:ListItem Value="2" Text="Rejected by RCMS/by BEFTN for Invalid Information"></asp:ListItem>
                ...
                <asp:Panel ID="pnlReportSettlement" runat="server" Height="400px" Width="900px">
                    <asp:DataGrid ID="dtgSettlementReport" runat="Server" AlternatingItemStyle-BackColor="lightyellow"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="DDIEDRID" HeaderText="DDIEDRID" SortExpression="DDIEDRID">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="DDIBatchID" HeaderText="DDIBatchID" SortExpression="DDIBatchID">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="SenderAccountNo" HeaderText="SenderAccountNo" SortExpression="SenderAccountNo">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="ReceivingBankRoutingNo" HeaderText="ReceivingBankRoutingNo" SortExpression="ReceivingBankRoutingNo">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="ReferenceNo" HeaderText="ReferenceNo" SortExpression="ReferenceNo">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="DebitorAccountName" HeaderText="DebitorAccountName" SortExpression="DebitorAccountName">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="Reason" HeaderText="Reason" SortExpression="Reason">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="ReturnCode" HeaderText="ReturnCode" SortExpression="ReturnCode">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="ReturnReason" HeaderText="ReturnReason" SortExpression="ReturnReason">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="SettelementDate" HeaderText="SettelementDate" SortExpression="SettelementDate">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                        </Columns>
            ...
            <div style="margin-top: 25px">
                <table style="padding-top: 15px">
                    <tr height="20">
                        <td width="200px"></td>
                        <td>
                            <a href="ChangeCSGUserPassword.aspx" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image3','','images/ChangePasswordOn.gif',1)">
