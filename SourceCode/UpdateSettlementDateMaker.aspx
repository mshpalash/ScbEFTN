<%@ Page Language="C#" AutoEventWireup="true" Codebehind="UpdateSettlementDateMaker.aspx.cs"
    Inherits="EFTN.UpdateSettlementDateMaker" %>
...
<head id="Head1" runat="server">
    <title>Update Settlement Date</title>
            ...
            <div align="center" class="boxmodule" style="padding-top:10px; width:500px; margin-top:10px; height:300px; margin-left:220px">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Calendar ID="clnderSettlementDate" runat="server" BackColor="White" BorderColor="#3366CC"
