<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FlatFileForTransactionSentToHUB.aspx.cs"
    Inherits="EFTN.FlatFileForTransactionSentToHUB" %>
...
<body class="wrap" id="content">
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div style="padding-top: 10px; width: 940px; margin-top: 10px;
                    height: 40px; margin-left: 15px">
                <table>
                    <tr>
                        <td>
                            <asp:LinkButton ID="linkBtnTransactionSentCharge" runat="server" Text="Transaction Sent Charge Flat File" class="CommandButton" OnClick="linkBtnTransactionSentCharge_Click"></asp:LinkButton>
                        </td>
                    </tr>
                </table>
            </div>            
                ...
                <div align="center" id="AvailDiv" runat="server" style="position: relative; overflow: auto;
                    ...
                    <asp:DataGrid ID="dtgEFTChecker" AlternatingItemStyle-BackColor="lightyellow" AutoGenerateColumns="false"
                        ...
                        AllowPaging="true" PageSize="1000" OnPageIndexChanged="dtgEFTChecker_PageIndexChanged" OnItemCommand="dtgEFTChecker_ItemCommand">
                        <Columns>
                            ...
                            <asp:ButtonColumn CommandName="GenerateFlatFile" Text="Generate Credit Flat File" CausesValidation="false"></asp:ButtonColumn>
                            <asp:ButtonColumn CommandName="GenerateReverseFlatFile" Text="Generate Debit Flat File" CausesValidation="false"></asp:ButtonColumn>
                  ...
                  <asp:DataGrid ID="dtgISOMessageStatus" AlternatingItemStyle-BackColor="lightyellow" AutoGenerateColumns="false"
                        ...
                        AllowPaging="true" PageSize="50" OnPageIndexChanged="dtgEFTChecker_PageIndexChanged" OnItemCommand="dtgEFTChecker_ItemCommand">
                        <Columns>
