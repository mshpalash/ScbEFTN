<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CSVRejectionReport.aspx.cs" Inherits="EFTN.CSVRejectionReport" %>
    ...
    <form id="form2" method="post" runat="server">
        <div class="maincontent">
            ...
            <div style="overflow: auto; width: 940px; margin-left: 100px; margin-left: 15px">
                <asp:Panel ID="pnlReportCSVRejection" runat="server" Height="400px" Width="900px">
                    <asp:DataGrid ID="dtgCSVRejectionReport" runat="Server" AlternatingItemStyle-BackColor="lightyellow"
                        ...
                        ItemStyle-CssClass="NormalSmall" ShowFooter="true" PagerStyle-Position="Top"  PageSize="500" AllowPaging="True" AllowSorting="True" OnPageIndexChanged="dtgCSVRejectionReport_PageIndexChanged">
                        <Columns>
                            <asp:TemplateColumn HeaderText="SL.">
                                <ItemTemplate>
                                    <%#(dtgCSVRejectionReport.PageSize * dtgCSVRejectionReport.CurrentPageIndex) + Container.ItemIndex + 1%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:BoundColumn DataField="BankName" HeaderText="Bank Name"  SortExpression = "BankName" >
                            ...
                            <asp:BoundColumn DataField="FlagDFIAccountNoLength" HeaderText="DFIAccount No Status"  SortExpression = "FlagDFIAccountNoLength" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="AccountNo" HeaderText="AccountNo"  SortExpression = "AccountNo" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="FlagAccountNoLength" HeaderText="AccountNo Status"  SortExpression = "FlagAccountNoLength" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="BankRoutingNo" HeaderText="Receiving Bank Routing No"  SortExpression = "BankRoutingNo" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="FlagReceivingBankRT" HeaderText="ReceivingBank RoutingNo. Status"  SortExpression = "FlagReceivingBankRT" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>                                                        
                            ...
                            <asp:BoundColumn DataField="FlagAmount" HeaderText="Amount Status"  SortExpression = "FlagAmount" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="FlagIdNumber" HeaderText="IdNumber Status"  SortExpression = "FlagIdNumber" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="ReceiverName" HeaderText="Receiver Name"  SortExpression = "ReceiverName" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="FlagReceiverName" HeaderText="Receiver Name Status"  SortExpression = "FlagReceiverName" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="PaymentInfo" HeaderText="Payment Info"  SortExpression = "PaymentInfo" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="FlagPaymentInfo" HeaderText="Payment Info Status" SortExpression="FlagPaymentInfo">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="FlagDuplicateData" HeaderText="Duplicate Status" SortExpression="FlagDuplicateData">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="BeneficiaryBankcode" HeaderText="Beneficiary Bank code" ItemStyle-Wrap="False" HeaderStyle-Wrap="False" />
                            <asp:BoundColumn DataField="LocalBankClearingCode" HeaderText="Local Bank Clearing Code" ItemStyle-Wrap="False" HeaderStyle-Wrap="False" />
                            <asp:BoundColumn DataField="PayeeAddress2BO" HeaderText="Payee Address 2 BO" ItemStyle-Wrap="False" HeaderStyle-Wrap="False" />
                            <asp:BoundColumn DataField="EntryDateTransactionSent" HeaderText="Transaction Entry Time" ItemStyle-Wrap="False" HeaderStyle-Wrap="False" />
