<%@ Page Language="C#" AutoEventWireup="true" Codebehind="EFTChargeReportAccountWise.aspx.cs" Inherits="EFTN.EFTChargeReportAccountWise" %>
...
<head runat="server">
    ...
    <title>Account Wise Charge Report</title>
    ...
    <form id="form1" runat="server">
        <div class="maincontent" style="height:550px">
            ...
            <div class="Head" align="center">
                Account Wise Charge Report</div>
        <div align="center">
            <table>
                <tr height="10px">
                    <td>
                ...
                <div style="overflow: auto;" align="center">
                    <asp:Panel ID="pnlChargeReportDateWise" runat="server" Height="400px" Width="900px">
                        <asp:DataGrid ID="dtgChargeReport" runat="Server" AlternatingItemStyle-BackColor="lightyellow"
                            ...
                            <Columns>
                                <asp:BoundColumn DataField = "AccountNumber" HeaderText="Account Number" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                                <asp:BoundColumn DataField = "SentItems" HeaderText="Sent Items" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                                <asp:BoundColumn DataField = "Charge" HeaderText="Charge" DataFormatString="{0:N}" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                                <asp:BoundColumn DataField = "BankCharge" HeaderText="Bank Charge" DataFormatString="{0:N}" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                                <asp:BoundColumn DataField = "DeductCharge" HeaderText="Deduct Charge" DataFormatString="{0:N}" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                                <asp:BoundColumn DataField = "BankDeductCharge" HeaderText="Bank Deduct Charge" DataFormatString="{0:N}" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                                <asp:BoundColumn DataField = "TotalDeductCharge" HeaderText="Total Deduct Charge" DataFormatString="{0:N}" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                                <asp:BoundColumn DataField = "VatonTotalDeductCharge" HeaderText="VAT on Total Deduct Charge" DataFormatString="{0:N}" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                                <asp:BoundColumn DataField = "TotalDeductChargewithVat" HeaderText="Total Deduct Charge with VAT" DataFormatString="{0:N}" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                            </Columns>
