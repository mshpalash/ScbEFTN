<%@ Page Language="C#" AutoEventWireup="true" Codebehind="BranchWiseTransactionStatus.aspx.cs"
    Inherits="EFTN.BranchWiseTransactionStatus" %>
...
<head id="Head1" runat="server">
    <title>BranchWise Transaction Status</title>
    ...
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div class="Head" align="center">
               BranchWise Transaction Status</div>
            <div>
            ...
            <div align="center" id="AvailDiv" runat="server" style="position: relative; overflow: auto; height: 380px;
                ...
                <asp:DataGrid ID="dtgBranchWiseSettlementReport" runat="Server" Width="600" BorderWidth="0px"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="BranchName" HeaderText="BranchName" ItemStyle-Wrap="False" HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="TotalItem" HeaderText="TotalItem" ItemStyle-Wrap="False" HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="TotalAmount" HeaderText="TotalAmount" ItemStyle-Wrap="False" HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="ReturnItem" HeaderText="ReturnItem" ItemStyle-Wrap="False" HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="ReturnAmount" HeaderText="ReturnAmount" ItemStyle-Wrap="False" HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="ApprovedItem" HeaderText="ApprovedItem" ItemStyle-Wrap="False" HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="ApprovedAmont" HeaderText="ApprovedAmont" ItemStyle-Wrap="False" HeaderStyle-Wrap="False" />
                    </Columns>
                </asp:DataGrid>
            </div>
        </div>
