...
namespace EFTN.BLL
{
    public class ValidateExelFieldForStandingOrderCity
    {
        ...
        public string ValidateExcelForEFTStandingOrderCity(string excelFilePath, string SelectedBank, int paymentType)
        {
            ...
            //dtExcel = eftCSVReader.ReadCSV(excelFilePath);
            ...
            //foreach (DataRow row in data.Rows)
            {
                ...
                try
                {
                    accountType = dtExcel.Rows[i]["CBL CASA A/C Type"].ToString().Trim();
                }
                catch
                {
                    errorString.AppendLine("\"CBL CASA A/C Type\" column not found");
                    break;
                }
                ...
                try
                {
                    dfiAccNo = dtExcel.Rows[i]["Customer A/C No with Other Bank"].ToString().Trim();
                }
                catch
                {
                    errorString.AppendLine("\"Customer A/C No with Other Bank\" column not found");
                    break;
                }
                ...
                try
                {
                    accNo = dtExcel.Rows[i]["CBL CASA A/C No"].ToString().Trim();
                }
                catch
                {
                    errorString.AppendLine("\"CBL CASA A/C No\" column not found");
                    break;
                }
                ...
                try
                {
                    ...
                    if (stdBeginDate <= System.DateTime.Today)
                    {
                        errorString.Append("Row No. = ");
                        errorString.Append(rowNumber);
                        errorString.AppendLine(" - \"Installment Start Date\" sould be greater than current date");
                    }
                }
                catch
                {
                ...
                try
                {
                    strEndDate = dtExcel.Rows[i]["Loan Expairy Date"].ToString().Trim();
                    if (strEndDate.Equals(string.Empty))
                    {
                        ...
                        errorString.Append("Row No. = ");
                        errorString.Append(rowNumber);
                        errorString.AppendLine(" - Invalid \"Loan Expairy Date\"");
                    }
                    ...
                    if (stdEndDate <= System.DateTime.Today)
                    {
                        errorString.Append("Row No. = ");
                        errorString.Append(rowNumber);
                        errorString.AppendLine(" - \"Loan Expiry Date\" should be greater current date");
                    }
                }
                catch
                {
                    ...
                    {
                        errorString.AppendLine("\"Loan Expairy Date\" column not found");
                        break;
                    }
                }
