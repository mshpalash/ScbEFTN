...
namespace EFTN.BLL
{
    public class ValidateExelFieldForStandingOrderNRB
    {
        ...
        public string ValidateExcelForEFTStandingOrderNRB(string excelFilePath, string SelectedBank, int paymentType)
        {
