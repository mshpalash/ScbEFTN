<%@ Page Language="C#" AutoEventWireup="true" Codebehind="BACHBranchReportCA.aspx.cs"
    Inherits="EFTN.BACHBranchReportCA" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddListReportType" runat="server">
                                <asp:ListItem Value="1" Text="BACH Brach" Selected="True"></asp:ListItem>
                                <asp:ListItem Value="2" Text="Non-BACH Brach"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
