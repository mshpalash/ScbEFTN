<%@ Page Language="C#" AutoEventWireup="true" Codebehind="InwardTransactionStatusReport.aspx.cs" Inherits="EFTN.InwardTransactionStatusReport" %>
...
<head id="Head1" runat="server">
    <title>Inward Debit Summary Report</title>
    ...
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div id="AvailDiv" runat="server" align="center" class="boxmodule" style="padding-top: 10px;
                width: 900px; margin-top: 10px; height: 40px; margin-left: 50px; ">
                <table>
                    <tr>
                        <td class="NormalBold">
                        ...
                        <td>
                            <asp:DropDownList ID="ddListReportType" runat="server">
                                <asp:ListItem Value="1" Text="Inward Transaction Status Report" Selected="True"></asp:ListItem>
                                <asp:ListItem Value="2" Text="Outward Return (of Inward TXN) Status Report"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
            ...
            <asp:Label ID="lblStatusReport" CssClass="NormalRed" runat="Server"></asp:Label><br />
                <asp:DataGrid ID="dtgInwardTransactionStatusReport" runat="Server" Width="600" BorderWidth="0px" GridLines="None"
                    ...
                    <Columns>
                      ...
                      <asp:BoundColumn DataField="IMItem" HeaderText="Total Items in Maker" ItemStyle-Wrap="True" HeaderStyle-Wrap="True" />
                        <asp:BoundColumn DataField="IMAmt" DataFormatString="{0:N}" HeaderText="Total Amount in Maker" ItemStyle-Wrap="True" HeaderStyle-Wrap="True" />
                        <asp:BoundColumn DataField="IMBDAItem" HeaderText="By Default Approved Item" ItemStyle-Wrap="True" HeaderStyle-Wrap="True" />
                        <asp:BoundColumn DataField="IMBDAAmt" DataFormatString="{0:N}" HeaderText="By Default Approved Amount" ItemStyle-Wrap="True" HeaderStyle-Wrap="True" />
                        <asp:BoundColumn DataField="ICItem" HeaderText="Total Items in Checker" ItemStyle-Wrap="True" HeaderStyle-Wrap="True" />
                        <asp:BoundColumn DataField="ICAmt" DataFormatString="{0:N}" HeaderText="Total Amount in Checker" ItemStyle-Wrap="True" HeaderStyle-Wrap="True" />
                        <asp:BoundColumn DataField="IEBBSItem" HeaderText="Total Items in CBS" ItemStyle-Wrap="True" HeaderStyle-Wrap="True" />
                        <asp:BoundColumn DataField="IEBBSAmt" DataFormatString="{0:N}" HeaderText="Total Amount in CBS" ItemStyle-Wrap="True" HeaderStyle-Wrap="True" />
                        <asp:BoundColumn DataField="IEBBSAItem" HeaderText="Total Items Approved By CBS" ItemStyle-Wrap="True" HeaderStyle-Wrap="True" />
                        <asp:BoundColumn DataField="IEBBSAAmt" DataFormatString="{0:N}" HeaderText="Total Amount Approved By CBS" ItemStyle-Wrap="True" HeaderStyle-Wrap="True" />
                        <asp:BoundColumn DataField="CAItem" HeaderText="Total Items in Checker Authorizer" ItemStyle-Wrap="True" HeaderStyle-Wrap="True" />
                        <asp:BoundColumn DataField="CAAAmt" DataFormatString="{0:N}" HeaderText="Total Amounts Checker Authorizer" ItemStyle-Wrap="True" HeaderStyle-Wrap="True" />
                        ...
                        <asp:BoundColumn DataField="CAPAAmt" DataFormatString="{0:N}" HeaderText="Total Amount Sent By Checker Authorizer" ItemStyle-Wrap="True" HeaderStyle-Wrap="True" />
