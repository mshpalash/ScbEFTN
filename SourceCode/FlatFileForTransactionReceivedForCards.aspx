<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlatFileForTransactionReceivedForCards.aspx.cs"
    Inherits="EFTN.FlatFileForTransactionReceivedForCards" %>
                    ...
                    <tr>
                        ...
                        <td class="Normal">
                            <asp:LinkButton ID="LinkButton1" runat="server" Text="Generate"
                                CssClass="CommandButton" OnClientClick="return confirm('Are you sure you want to generate flat files for Cards?')"
