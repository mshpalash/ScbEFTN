<%@ Page Language="C#" AutoEventWireup="true" Codebehind="InwardDebitSummaryReport.aspx.cs" Inherits="EFTN.InwardDebitSummaryReport" %>
    ...
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <asp:Label ID="lblStatusReport" CssClass="NormalRed" runat="Server"></asp:Label><br />
                <asp:DataGrid ID="dtgInwardDebitSummaryReport" runat="Server" Width="600" BorderWidth="0px" GridLines="None"
