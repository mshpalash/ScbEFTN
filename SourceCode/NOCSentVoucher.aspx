<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NOCSentVoucher.aspx.cs" 
    Inherits="EFTN.NOCSentVoucher" MaintainScrollPositionOnPostback="true" %>
            ...
            <tr>
                ...
                <td>
                       ...
                       <asp:DataGrid ID="dtgEFTChecker" AlternatingItemStyle-BackColor="lightyellow" AutoGenerateColumns="false"
                            ...
                            ItemStyle-CssClass="NormalSmall" runat="server" DataKeyField="NOCID"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="Select">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkBoxNOCSent" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="NOC Reason" SortExpression = "ReturnReason">
                                    <ItemTemplate>
