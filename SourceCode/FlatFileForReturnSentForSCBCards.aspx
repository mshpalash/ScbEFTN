<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FlatFileForReturnSentForSCBCards.aspx.cs"
    Inherits="EFTN.FlatFileForReturnSentForSCBCards" %>
...
<head id="Head1" runat="server">
    <title>Flat files for Cards</title>
...
<body class="wrap" id="content">
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div align="center" class="boxmodule" style="padding-top:10px; width:800px; margin-top:10px; height:40px; margin-left:100px">
            <table>
                    <tr>
                        <td class="NormalBold">
                        ...
                        <td width="10"></td>
                        <td class="Normal">
                            <asp:LinkButton ID="btnGenerateFlatFileForReturnSentForCard" runat="server" Text="Generate"
                                CssClass="CommandButton" OnClientClick="return confirm('Are you sure you want to generate flat files for Return Sent for Cards?')"
                                OnClick="btnGenerateFlatFileForReturnSentForCard_Click" /></td>
                    </tr>
            </table>
            </div>
            <div align="center" id="AvailDiv" runat="server" style="position: relative; overflow: auto;
                    width: 900px; margin-top: 15px; height: 300px;">
               <asp:DataGrid ID="dtgReturnSent" runat="Server" Width="600" BorderWidth="0px"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="SL.">
                                        <ItemTemplate>
                                            <%#(dtgReturnSent.PageSize * dtgReturnSent.CurrentPageIndex) + Container.ItemIndex + 1%>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    ...
                                    <asp:BoundColumn DataField="valueDate" HeaderText="valueDate" ItemStyle-Wrap="False"
                                        HeaderStyle-Wrap="False" />
                                    <asp:BoundColumn DataField="Narration1" HeaderText="Narration1" ItemStyle-Wrap="False"
                                        HeaderStyle-Wrap="False" />
                                    <asp:BoundColumn DataField="Narration2" HeaderText="Narration2" ItemStyle-Wrap="False"
                                        HeaderStyle-Wrap="False" />
                                    <asp:BoundColumn DataField="Narration3" HeaderText="Narration3" ItemStyle-Wrap="False"
                                        HeaderStyle-Wrap="False" />
                                </Columns>
                            </asp:DataGrid>
            </div>
