<%@ Page Language="C#" AutoEventWireup="true" Codebehind="UpdateInactiveBranch.aspx.cs"
    Inherits="FloraSoft.UpdateInactiveBranch" %>
    ...
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div align="center" class="boxmodule" style="width: 540px; margin-left: 200px; padding-top: 15px;
                padding-left: 15px; margin-bottom: 15px; margin-top: 15px; height: 80px">
                <br /><br />
                <table>
                    <tr>
                        <td>
                ...
                <asp:DataGrid ID="MyDataGrid" HeaderStyle-CssClass="GrayBackWhiteFont" FooterStyle-CssClass="GrayBackWhiteFont"
                    ...
                    <Columns>
                        <asp:TemplateColumn HeaderText="Select">
                          ...
                          <asp:TemplateColumn HeaderText="Bank Name" FooterStyle-CssClass="red">
                            <ItemTemplate>
