<%@ Page Language="C#" AutoEventWireup="true" Codebehind="TransactionSentStatusReport.aspx.cs"
    Inherits="EFTN.TransactionSentStatusReport" %>
...
<head id="Head1" runat="server">
    <title>Transaction Status Report</title>
        ...
        <div class="maincontent">
           ...
           <div>
            ...
            <div id="AvailDiv" runat="server" align="center" class="boxmodule" style="padding-top: 10px;
                width: 650px; margin-top: 10px; height: 40px; margin-left: 200px; ">
                <table>
                    <tr>
                        <td class="NormalBold">
            ...
            <div style="overflow: auto;width: 825px; margin-left:125px">                
            <asp:Label ID="lblStatusReport" CssClass="NormalRed" runat="Server"></asp:Label><br />
                <asp:DataGrid ID="dtgStatusReport" runat="Server" Width="640px" 
...
<AlternatingItemStyle BackColor="White"></AlternatingItemStyle>
                    <Columns>
<asp:BoundColumn DataField="BatchNumber" HeaderText="Batch No">
</asp:BoundColumn>
                        <asp:BoundColumn DataField="TotalTransaction" HeaderText="Total Transaction" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" >
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="TotalAmount" HeaderText="Total Amount">
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="XmlFileName" HeaderText="Xml File Name" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" >
<HeaderStyle Wrap="False"></HeaderStyle>

<ItemStyle Wrap="False"></ItemStyle>
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="AckStatus" HeaderText="Ack Status" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" >
<HeaderStyle Wrap="False"></HeaderStyle>

<ItemStyle Wrap="False"></ItemStyle>
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="FileEntryDate" HeaderText="File Entry Date" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" >
                            <HeaderStyle Wrap="False" />
                            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" 
                                Font-Strikeout="False" Font-Underline="False" Wrap="False" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="TraceNumberStart" HeaderText="Trace No Start">
                            <HeaderStyle Wrap="False" />
                            <ItemStyle Wrap="False" />
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="TraceNumberEnd" HeaderText="Trace No End">
                        </asp:BoundColumn>
                    </Columns>
