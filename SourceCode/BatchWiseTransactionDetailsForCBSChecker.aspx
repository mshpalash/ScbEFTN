<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchWiseTransactionDetailsForCBSChecker.aspx.cs" Inherits="EFTN.BatchWiseTransactionDetailsForCBSChecker" %>
...
<body class="wrap" id="content">
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <br />
            <div align="center">
                <a href="BatchSentVoucher.aspx" class="CommandButton"> Transaction Sent Batch</a>
            </div>
            <div id="divDelete" runat="server" align="center" class="boxmodule" style="padding-top: 10px; width: 940px; margin-top: 10px;
                    height: 50px; margin-left: 15px; margin-bottom: 20px; ">
                <table>
                    <tr>
                        <td>
                            <asp:LinkButton ID="btnDelete" runat="server" Text="Delete" CssClass="CommandButton"
                                
                                OnClientClick="return confirm('Are you sure you want to delete the transactions?')" 
            ...
            <div align="center">
                <asp:DataGrid ID="dtgTransactionDetails" runat="Server" Width="600" BorderWidth="0px"
                 ...
                 PageSize="50"  DataKeyField="EDRID" >
                    <Columns>
