<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BulkTransactionList.aspx.cs"
    Inherits="EFTN.BulkTransactionList" MaintainScrollPositionOnPostback="true" %>
                            ...
                            <div align="center" class="boxmodule" style="padding-top: 10px; width: 940px; margin-top: 10px; height: 40px; margin-left: 15px">
                                <table>
                                    <tr>
                                        ...
                                        <td width="75px"></td>
                                        <td>
                                            <asp:Button runat="server" ID="btnCancel" Text="Delete" OnClick="btnCancel_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
                                    ...
                                    <tr>
                                        <td class="NormalBold" align="center">
                                            <asp:DataGrid ID="dtgBatchTransactionSent" runat="Server" BorderWidth="0px" GridLines="None"
                                                ...
                                                ItemStyle-BackColor="#dee9fc" AlternatingItemStyle-BackColor="#ffffff" DataKeyField="TransactionID" AllowPaging="True" PageSize="500">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="">
                                                        <ItemTemplate>
                                                            <a href="BulkTransactionEdit.aspx?TransactionID=<%#DataBinder.Eval(Container.DataItem, "TransactionID")%>">Batch Details</a>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
                                                    ...
                                                    <asp:BoundColumn DataField="DataEntryType" HeaderText="Upload Type" ItemStyle-Wrap="False"
                                                        HeaderStyle-Wrap="False">
                                                        <HeaderStyle Wrap="False"></HeaderStyle>
                                                        <ItemStyle Wrap="False"></ItemStyle>
                                                    </asp:BoundColumn>
                                                   ...
                                                   <%--  <asp:BoundColumn DataField="LoginID" HeaderText="Created By" ItemStyle-Wrap="False" HeaderStyle-Wrap="False">
                                                        <HeaderStyle Wrap="False"></HeaderStyle>
                                                        <ItemStyle Wrap="False"></ItemStyle>
                                                    </asp:BoundColumn>--%>
                                                </Columns>
