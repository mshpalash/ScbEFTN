<%@ Page Language="C#" AutoEventWireup="true" Codebehind="CreditFCUBSForEftDebitTXN.aspx.cs"
    Inherits="EFTN.CreditFCUBSForEftDebitTXN" %>
...
<head id="Head1" runat="server">
    <title>Credit CBS for EFT Outward</title>
    ...
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div class="Head" align="center">
                Credit FCUBS Account for EFT Outward Debit</div> 
                <div align="center" class="boxmodule" style="padding-top: 10px; width: 940px; margin-top: 10px;
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="NormalBold">
                                <asp:Label ID="lblDay" runat="server" Text="Select Settlement Date"></asp:Label>
                            </td>
                            <td>
                                <table>
                                    <tr>
                ...
                <div align="center" class="boxmodule" style="padding-top: 10px; width: 940px; margin-top: 10px;
                    ...
                    <asp:TextBox ID="txtMsg" Width="800px" Height="70px" runat="server" TextMode="MultiLine"></asp:TextBox>
                </div>
                    ...
                    <asp:DataGrid ID="dtgEFTChecker" AlternatingItemStyle-BackColor="lightyellow" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="">
                                <ItemTemplate>
                                    <a href="BatchWiseDebitTransactionDetails.aspx?TransactionEDRID=<%#DataBinder.Eval(Container.DataItem, "TransactionID")%>">
                                        Batch Details</a>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            ...
                            <asp:TemplateColumn HeaderText="Total Transactions">
                                <ItemTemplate>
                                    <%#DataBinder.Eval(Container.DataItem, "TotalTransactions")%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="CBS Error Cnt">
                                <ItemTemplate>
                                    <%#DataBinder.Eval(Container.DataItem, "CBSError")%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:ButtonColumn CommandName="GenerateFlatFile" Text="Credit FCUBS Account" CausesValidation="false"></asp:ButtonColumn>
                        </Columns>
