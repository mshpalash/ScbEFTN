<%@ Page Language="C#" AutoEventWireup="true" Codebehind="InwardTransactionRejectedByFCUBS.aspx.cs"
    Inherits="EFTN.InwardTransactionRejectedByFCUBS" MaintainScrollPositionOnPostback="true" %>
    ...
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div class="Head" align="center">
                Inward Transaction Rejected by FCUBS</div>
            <div>
                        ...
                        <td colspan="3">
                            <asp:DataGrid ID="dtgEFTCheckerApproved" AlternatingItemStyle-BackColor="lightyellow"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="CBSErrorMsg" SortExpression = "CBSErrorMsg">
                                        <ItemTemplate>
                    ...
                    <tr>
                        <td>
                            <table>
                                <tr>
                                    <td>
                                        <asp:LinkButton ID="btnReprocess" runat="server" Text="Re-process" CssClass="CommandButton"
                                            OnClientClick="return confirm('Are you sure you want to reprocess?')" 
                                            onclick="btnReprocess_Click"></asp:LinkButton></td>
                                    <td width="50">
                                    </td>
                                    <td>
                                        <asp:LinkButton ID="btnReturn" runat="server" Text="Return" CssClass="CommandButton"
                                            OnClientClick="return confirm('Are you sure you want to return?')" 
                                            onclick="btnReturn_Click"></asp:LinkButton></td>
                                </tr>
                                <tr>
                                    <td width="40%">
                                        <asp:Label ID="lblRejectInstruction" runat="server" CssClass="NormalBold" Text="Please Enter Remarks"></asp:Label></td>
                                    <td colspan="2" width="60%">
                                    </td>
                                </tr>
                                <tr>
                                    <td width="40%">
                                        <asp:TextBox ID="txtRejectedReason" TextMode="MultiLine" runat="server" Width="300" MaxLength="35" OnKeyUp="return makeUppercase(this.name);"></asp:TextBox></td>
                                    <td colspan="2" width="60%">
                                        <asp:Label ID="lblNoReturnReason" runat="server" Text="Please Enter Remarks(max 35 characters)"
