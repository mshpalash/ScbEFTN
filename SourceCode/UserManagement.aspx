<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserManagement.aspx.cs" Inherits="FloraSoft.UserManagement" MaintainScrollPositionOnPostback="true" %>
            ...
            <asp:datagrid Id="MyDataGrid2"
                ...
                <Columns>
                    ...
                    <asp:TemplateColumn HeaderText="Password" ItemStyle-HorizontalAlign="Left" FooterStyle-CssClass="red">
                        <ItemTemplate>
                            <a href="ResetPassword.aspx?ResetUserID=<%#DataBinder.Eval(Container.DataItem, "UserID")%>">Reset Password</a>
                        </ItemTemplate>
                    </asp:TemplateColumn>                    
