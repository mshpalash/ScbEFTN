<%@ Page Language="C#" AutoEventWireup="true" Codebehind="StandingOrderTransactionList.aspx.cs"
    Inherits="EFTN.StandingOrderTransactionList" MaintainScrollPositionOnPostback="true" %>
                                            ...
                                            <asp:DataGrid ID="dtgStandingOrderBatch" runat="Server" BorderWidth="0px" GridLines="None"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="">
                                                        <ItemTemplate>
                                                            <a href="StandingOrderTransactionEdit.aspx?StandingOrderBatchID=<%#DataBinder.Eval(Container.DataItem, "StandingOrderBatchID")%>">
                                                                Edit</a>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>                                                  
