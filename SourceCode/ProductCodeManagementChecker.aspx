<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductCodeManagementChecker.aspx.cs" Inherits="FloraSoft.ProductCodeManagementChecker" %>
...
<head id="Head1" runat="server">
    <title>Product Code Management</title>
...
<body class="wrap" id="content">
    ...
    <uc1:Header ID="Header" runat="server" />
        <div class="Head" align="center">Product Code Management</div>
        <div align="center">
            <table>
                <tr height="10px">
                    <td>
        ...
        <div align="center" class="boxmodule" style="width:940px;margin-left:20px; padding-top:15px; padding-left:15px; min-height:400px; overflow: scroll; margin-bottom:15px; margin-top:20px">
            ...
            <asp:datagrid Id="MyDataGrid2"
                ...
                autogeneratecolumns="false"  DataKeyField="ChargeProductID" 
                gridlines="None" borderwidth="0px" ShowFooter="true"  Height="0px"
                OnItemCommand="MyDataGrid2_ItemCommand">
                <Columns>
                    <asp:TemplateColumn HeaderText="ProductID" HeaderStyle-Wrap="false"  ItemStyle-Wrap="false"  ItemStyle-HorizontalAlign="Left" FooterStyle-CssClass="red" HeaderStyle-Width="60px" FooterStyle-Width="120px" ItemStyle-Width="120px" >
                        <ItemTemplate>
                            <%#DataBinder.Eval(Container.DataItem, "ChargeProductID")%>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:TemplateColumn HeaderText="Product Code" HeaderStyle-Wrap="false"  ItemStyle-Wrap="false"  ItemStyle-HorizontalAlign="Left" FooterStyle-CssClass="red" HeaderStyle-Width="60px" FooterStyle-Width="120px" ItemStyle-Width="120px" >
                        <ItemTemplate>
                            <%#DataBinder.Eval(Container.DataItem, "ProductCode")%>
                        </ItemTemplate>
                        <EditItemTemplate>
                             <asp:TextBox ID="txtACCOUNT" runat="server" Width="120px" 
                             Text='<%#DataBinder.Eval(Container.DataItem,"ProductCode") %>'></asp:TextBox>
                        </EditItemTemplate>
                         <FooterTemplate>
                                <asp:TextBox ID="addACCOUNT" Width="120"  Runat="Server" MaxLength="3" />
