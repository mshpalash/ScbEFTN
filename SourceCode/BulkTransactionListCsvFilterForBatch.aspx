<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BulkTransactionListCsvFilterForBatch.aspx.cs"
    Inherits="EFTN.BulkTransactionListCsvFilterForBatch" MaintainScrollPositionOnPostback="true" %>
...
<body class="wrap" id="content">
    ...
    <form id="form2" method="post" runat="server">
        <div class="maincontent">
            ...
            <div class="Head" align="Center">Filter Transactions and Move For Batch</div>
            <div align="center">
                <table style="">
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtAccountNo" runat="server" Width="200"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblEntryDescription" runat="server" Text="Payment Info: " Font-Bold="true"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtEntryDescription" runat="server" Width="200"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>
                            <asp:Button ID="btnSearch" runat="server" CssClass="inputlt" CausesValidation="false" Text="Search" Width="205" OnClick="btnSearch_Click" />
                        </td>
                        <td>
                            <asp:Button ID="btnSend" runat="server" CssClass="inputlt" CausesValidation="false" Text="Send" Width="80" OnClientClick="return confirm('Are you sure you want to move selected transactions?')" OnClick="btnSend_Click" />                           
                        </td>
                        <%--<td>
                ...
                <table>
                    <tr>
                        ...
                        <td class="NormalBlue">
                            <asp:Label ID="lblTotalFilteredTransaction" runat="server"></asp:Label>
                        </td>
                        <td class="NormalBlue">
                            <asp:Label ID="lblFilteredTotalAmount" runat="server"></asp:Label>
                        </td>
                    </tr>
                </table>
                <table>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td class="NormalBold" align="center">
                                            <asp:DataGrid ID="dtgFilteredBatchTransactionSent" runat="Server" BorderWidth="0px" GridLines="None"
                                                ...
                                                ItemStyle-BackColor="#dee9fc" AlternatingItemStyle-BackColor="#ffffff" DataKeyField="OID" AllowPaging="True" OnPageIndexChanged="dtgFilteredBatchTransactionSent_PageIndexChanged" PageSize="500">
