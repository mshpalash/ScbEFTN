<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChargeAccountManagementChecker.aspx.cs" Inherits="FloraSoft.ChargeAccountManagementChecker" %>
    ...
    <uc1:Header ID="Header" runat="server" />
        ...
        <div align="center" class="boxmodule" style="width:940px;margin-left:20px; padding-top:15px; padding-left:15px; min-height:400px; overflow: scroll; margin-bottom:15px; margin-top:20px">
            ...
            <asp:datagrid Id="MyDataGrid2"
                ...
                autogeneratecolumns="false"  DataKeyField="ChargeAccountID" 
                gridlines="None" borderwidth="0px" ShowFooter="true"  Height="0px"
                OnItemCommand="MyDataGrid2_ItemCommand">
                <Columns>
                    <asp:TemplateColumn HeaderText="ChargeAccountID" HeaderStyle-Wrap="false"  ItemStyle-Wrap="false"  ItemStyle-HorizontalAlign="Left" FooterStyle-CssClass="red" HeaderStyle-Width="60px" FooterStyle-Width="120px" ItemStyle-Width="120px" >
                        <ItemTemplate>
                            <%#DataBinder.Eval(Container.DataItem, "ChargeAccountID")%>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:TemplateColumn HeaderText="Account No." HeaderStyle-Wrap="false"  ItemStyle-Wrap="false"  ItemStyle-HorizontalAlign="Left" FooterStyle-CssClass="red" HeaderStyle-Width="60px" FooterStyle-Width="120px" ItemStyle-Width="120px" >
                        <ItemTemplate>
