<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DDIReport.aspx.cs"
    Inherits="EFTN.DDIReport" %>
...
<body class="wrap" id="content">
    <form id="form2" method="post" runat="server">
        <div class="maincontent">
            ...
            <div align="center" class="boxmodule" style="padding-top: 10px; width: 960px; margin-top: 10px; height: 60px; margin-left: 5px">
                <table>
                    <tr>
                        <td class="NormalBold" style="height: 30px">
                        ...
                        <td style="height: 30px">
                            <asp:DropDownList ID="ddListReportType" runat="server">
                                <asp:ListItem Value="1" Text="Successfull Outward Transaction" Selected="True"></asp:ListItem>
                                <asp:ListItem Value="2" Text="Inward Return From Other Banks"></asp:ListItem>
                                <asp:ListItem Value="3" Text="Total Transaction From RCMS"></asp:ListItem>
                                <asp:ListItem Value="4" Text="Internal Return Of RCMS Transaction"></asp:ListItem>
                                <asp:ListItem Value="5" Text=" Return After Approve Of RCMS Transaction"></asp:ListItem>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnExportToPdf" runat="server" Text="PDF" OnClick="ExpotToPdfBtn_Click" />
                        </td>
                        <td>
                            <asp:Button ID="BtnExpotToCSV" runat="server" Text="CSV File" OnClick="ExpotToExcelbtn_Click" />
                        </td>
                    </tr>
                </table>
            </div>
