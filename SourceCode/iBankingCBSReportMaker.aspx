<%@ Page Language="C#" AutoEventWireup="true" Codebehind="iBankingCBSReportMaker.aspx.cs"
    Inherits="EFTN.iBankingCBSReportMaker" %>
            ...
            <div style="overflow: auto; width: 940px; margin-left: 100px; margin-left: 15px">
                <asp:Panel ID="pnlReportSettlement" runat="server" Height="400px" Width="900px">
                    <asp:DataGrid ID="dtgSettlementReport" runat="Server" AlternatingItemStyle-BackColor="lightyellow"
                        ...
                        OnPageIndexChanged="dtgSettlementReport_PageIndexChanged" PageSize="5000"
                         AllowPaging="True" AllowSorting="True" 
                        OnSortCommand="dtgSettlementReport_SortCommand">
                        <Columns>
