<%@ Page Language="C#" AutoEventWireup="true" Codebehind="TransactionSentFiles.aspx.cs"
    Inherits="EFTN.TransactionSentFiles" %>
...
<head runat="server">
    <title>Transaction Sent Files</title>
...
<body class="wrap" id="content">
    ...
    <div class="maincontent">
        ...
        <div class="Head" align="center">Transaction Sent Files</div>
        <div>
            <div>
                <table cellpadding="5px">
                    <tr>
                        <td width="100px"></td>
                         <td colspan="3">
                                <asp:DataGrid ID="dtgTransactionSentFiles" runat="Server" Height="0px" 
                                ...
                                ItemStyle-CssClass="Normal" FooterStyle-CssClass="GrayBackWhiteFont"
