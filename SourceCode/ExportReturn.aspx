<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ExportReturn.aspx.cs" Inherits="EFTN.ExportReturn" %>
    ...
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div class="Head" align="center">
                Export Return</div>
            <div>
                <div id="AvailDiv" runat="server" style="position: relative; overflow: scroll; width: 750px;
                    height: 200px;">
                    <table>
                        <tr>
                            <td width="100px">
                            ...
                            <td class="NormalBold" align="center" colspan="2">
                                <asp:DataGrid ID="dtgBatchReturnSent" runat="Server" Width="600" BorderWidth="0px"
                            ...
                            <td colspan="2">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:LinkButton ID="btnGenerateXml" runat="server" Text="Generate Envelope" CssClass="CommandButton"
                                                OnClick="btnGenerateXml_Click" OnClientClick="return confirm('Are you sure you want to generate the envelop to export?')" /></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
