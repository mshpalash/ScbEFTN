<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ListOfDishonorRejectedByChecker.aspx.cs"
    Inherits="EFTN.ListOfDishonorRejectedByChecker" %>
    ...
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div class="Head" align="center">
                (Dishonor List) Rejected by checker which were approved by maker</div>
            <div style="overflow: scroll; width:940px; margin-left:20px">
                <asp:DataGrid ID="dtgListOfDishonorRejectedByChecker" runat="Server"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundColumn DataField="DishonorTraceNumber" HeaderText="DishonorTraceNumber"
                                        ItemStyle-Wrap="False" HeaderStyle-Wrap="true" />
