<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransReceivedVoucher.aspx.cs"
    Inherits="EFTN.TransReceivedVoucher" MaintainScrollPositionOnPostback="true" %>
    ...
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div align="center" class="boxmodule" style="padding-top: 10px; width: 940px; margin-top: 10px; height: 120px; margin-left: 15px">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="NormalBold">
                            <asp:Label ID="lblDay" runat="server" Text="Voucher For :"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddListReportType" runat="server">
                                <asp:ListItem Text="Settlement Date" Value="1" Selected="True"></asp:ListItem>
                                <asp:ListItem Text="Settlement Date(Only for print)" Value="2"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
            ...
            <div align="center" class="boxmodule" style="padding-top: 5px; width: 940px; margin-top: 5px; height: 20px; margin-left: 15px; padding-bottom: 5px"
                ...
                <a class="CommandButton" href="FinacleTransactionReceivedSynchronizer.aspx">Finacle Manager</a>
            </div>
            <div>
                <table>
                    <tr>
                            ...
                            <div align="center" id="AvailDiv" runat="server" style="position: relative; overflow: auto; width: 940px; margin-top: 15px; height: 300px;">
                                <asp:DataGrid ID="dtgEFTChecker" AlternatingItemStyle-BackColor="lightyellow" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateColumn HeaderText="Trace Number" SortExpression="EFTTraceNumber">
                                            <ItemTemplate>
                                                <%#DataBinder.Eval(Container.DataItem, "EFTTraceNumber")%>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
            ...
            <div align="center" class="boxmodule" style="padding-top: 10px; width: 940px; margin-top: 10px; height: 50px; margin-left: 15px; margin-bottom: 20px;">
                <table>
                    <tr>
                        <td>
                            <asp:LinkButton ID="btnAccept" runat="server" Text="Accept" CssClass="CommandButton" OnClientClick="return confirm('Are you sure you want to accept?')" OnClick="btnAccept_Click"></asp:LinkButton></td>

                        <td width="50px"></td>
                        <td>
                            <asp:LinkButton ID="btnReject" runat="server" Text="Reject" CssClass="CommandButton" OnClientClick="return confirm('Are you sure you want to reject?')" OnClick="btnReject_Click"></asp:LinkButton></td>
                        <td width="50px"></td>
                        <td>
                        ...
                        <td>
                            <asp:Label ID="lblNoReturnReason" runat="server" Text="Please Enter a return reason" Visible="false"></asp:Label></td>
