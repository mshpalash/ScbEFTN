<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FinacleTransactionReceivedSynchronizer.aspx.cs"
    Inherits="EFTN.FinacleTransactionReceivedSynchronizer" %>
            ...
            <div>
                <table style="padding-top: 15px;" width="900px">
                    <tr height="20px" align="center">
                        <td>
                            <a class="CommandButton" href="TransReceivedVoucher.aspx">Transaction Receive Voucher</a>
                        </td>
                    </tr>
                </table>
            </div>
                    ...
                    <asp:DataGrid ID="dtgEFTChecker" AlternatingItemStyle-BackColor="lightyellow" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="Success">
                                <ItemTemplate>
                                    <%#DataBinder.Eval(Container.DataItem, "Success")%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            ...
                            <asp:ButtonColumn CommandName="SendToFinacle" Text="Send To Finacle" CausesValidation="false"></asp:ButtonColumn>
