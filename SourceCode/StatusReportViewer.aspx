<%@ Page Language="C#" AutoEventWireup="true" Codebehind="StatusReportViewer.aspx.cs" Inherits="EFTN.StatusReportViewer" %>
    ...
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div id="AvailDiv" runat="server" align="center" class="boxmodule" style="padding-top: 10px;
                width: 780px; margin-top: 10px; height: 40px; margin-left: 200px; ">
                <table>
                    <tr>
                        <td class="NormalBold">
