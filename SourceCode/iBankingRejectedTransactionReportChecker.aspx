<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iBankingRejectedTransactionReportChecker.aspx.cs"
    Inherits="EFTN.iBankingRejectedTransactionReportChecker" %>
    ...
    <form id="form2" method="post" runat="server">
        <div class="maincontent">
            ...
            <div class="Head" align="center">
                iBanking Rejected Transaction Report Maker
            </div>
            <%--<div>
            ...
            <div align="center" class="boxmodule" style="padding-top: 10px; width: 960px; margin-top: 10px; height: 40px; margin-left: 5px">
                <table>
                    <tr>
                ...
                <asp:Panel ID="pnlReportSettlement" runat="server" Height="400px" Width="900px">
                    <asp:DataGrid ID="dtgSettlementReport" runat="Server" AlternatingItemStyle-BackColor="lightyellow"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn SortExpression="RejectedReason" HeaderText="Reject Reason">
                                <ItemTemplate>
                            ...
                            <asp:TemplateColumn SortExpression="RejectedReason" HeaderText="RejectedReason">
                                <ItemTemplate>
                                    <%#DataBinder.Eval(Container.DataItem, "RejectedReason")%>
                                </ItemTemplate>
                            </asp:TemplateColumn>

                            <asp:TemplateColumn SortExpression="RejectedBy" HeaderText="RejectedBy">
                                <ItemTemplate>
                                    <%#DataBinder.Eval(Container.DataItem, "RejectedBy")%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
