<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangeCSGUserPassword.aspx.cs"Inherits="EFTN.ChangeCSGUserPassword" %>

<%@ Register Src="modules/footer.ascx" TagName="footer" TagPrefix="uc2" %>
<%@ Register Src="modules/CSGReportViewerHeader.ascx" TagName="CSGReportViewerHeader" TagPrefix="uc1" %>
...
<body class="wrap" id="content">
    ...
    <div class="maincontent">
        <uc1:CSGReportViewerHeader ID="EFTHeader1" runat="server" />
