<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MakerCheckerLisitingReportViewer.aspx.cs" Inherits="EFTN.MakerCheckerLisitingReportViewer" %>


<%@ Register Src="modules/footer.ascx" TagName="footer" TagPrefix="uc2" %>
<%@ Register Src="modules/ReportViewerHeader.ascx" TagName="EFTCheckerHeader" TagPrefix="uc1" %>
                ...
                <asp:Panel ID="pnlReportSettlement" runat="server" Height="400px" Width="900px">
                    <asp:DataGrid ID="dtgReportMakerCheckerListing" runat="Server" AlternatingItemStyle-BackColor="lightyellow"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="EntryDateTransactionSent" HeaderText="Register Date"  SortExpression = "EntryDateTransactionSent">
