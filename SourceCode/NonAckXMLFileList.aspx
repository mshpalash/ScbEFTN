<%@ Page Language="C#" AutoEventWireup="true" Codebehind="NonAckXMLFileList.aspx.cs"
    Inherits="EFTN.NonAckXMLFileList" %>
                    ...
                    <tr>
                        ...
                        <td style="height: 46px">
                            <asp:DropDownList ID="ddListReportType" runat="server">
                                <asp:ListItem Value="1" Text="Non Ack Outward Transaction (Initial Transaction) File List"></asp:ListItem>
                                <asp:ListItem Value="2" Text="Non Ack Outward Return File List"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td style="height: 46px">
                        ...
                        <td>
                            <asp:Button runat="server" ID="btnResend" Text="Resend Selected Item" OnClick="btnResend_Click" />
                        </td>
                    </tr>
                </table>
            </div>
                ...
                <asp:Panel ID="pnlReportSettlement" runat="server" Height="400px" Width="900px">
                    <asp:DataGrid ID="dtgSettlementReport" runat="Server" AlternatingItemStyle-BackColor="lightyellow"
                        ...
                        HeaderStyle-CssClass="GrayBackWhiteFont" Height="0px" ItemStyle-BackColor="White"
                                            HeaderStyle-ForeColor="#FFFFFF" DataKeyField="XmlFileName"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn>
                                <ItemTemplate>
                                    <asp:CheckBox ID="cbxTSXMLList" runat="server" />
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:BoundColumn DataField = "OID" HeaderText="OID" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                            <asp:BoundColumn DataField = "TransactionID" HeaderText="TransactionID" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                            <asp:BoundColumn DataField = "BatchNumber" HeaderText="BatchNumber" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                            <asp:BoundColumn DataField = "TraceNumberStart" HeaderText="TraceNumberStart" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                            <asp:BoundColumn DataField = "TraceNumberEnd" HeaderText="TraceNumberEnd" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                            <asp:BoundColumn DataField = "XmlFileName" HeaderText="XmlFileName" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                            <asp:BoundColumn DataField = "AckStatus" HeaderText="AckStatus" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                            <asp:BoundColumn DataField = "FileEntryDate" HeaderText="FileEntryDate" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                            <asp:BoundColumn DataField = "TotalTransaction" HeaderText="TotalTransaction" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                            <asp:BoundColumn DataField = "TotalAmount" HeaderText="TotalAmount" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                            <asp:BoundColumn DataField = "BatchType" HeaderText="BatchType" ItemStyle-Wrap ="False"  HeaderStyle-Wrap="False" />
                        </Columns>
