<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ChangeAuthorizerPassword.aspx.cs"
    Inherits="EFTN.ChangeAuthorizerPassword" %>

<%@ Register Src="modules/footer.ascx" TagName="footer" TagPrefix="uc2" %>
<%@ Register Src="modules/CheckerAuthorizer.ascx" TagName="EFTCheckerAuthorizerHeader" TagPrefix="uc1" %>
...
<body class="wrap" id="content">
    <form id="form2" method="post" runat="server">
        <div class="maincontent" style="height:550px">
            <uc1:EFTCheckerAuthorizerHeader ID="EFTCAHeader" runat="server" />
            ...
            <div align="center" class="boxmodule" style="padding-top: 10px; width: 200px; margin-top: 10px;
                height: 50px; margin-left: 400px; padding-left: 15px">
                <table>
                    <tr align="left">
                        <td>
                        </td>
