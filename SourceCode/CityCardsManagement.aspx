<%@ Page Language="C#" AutoEventWireup="true" Codebehind="CityCardsManagement.aspx.cs" Inherits="EFTN.CityCardsManagement" %>
    ...
    <form id="form1" runat="server">
        <div class="maincontent" style="height:550px">
            ...
            <table  cellspacing="25px" cellpadding="25px">
                <tr>
                    <td align="center"><a href="CityCardsAccountManagement.aspx" class="CommandButton">Cards Account Management</a></td>
                    <td align="center"><a href="GenerateXMLForCardsCity.aspx" class="CommandButton">Export Transactions</a></td>
                    <td align="center"><a href="CityCardsCustomerManagement.aspx" class="CommandButton">Cards Customer Management</a></td>
                    <td align="center"><a href="CityCardsFailedList.aspx" class="CommandButton">Failed Cards Transaction</a></td>
                </tr>
            </table>
