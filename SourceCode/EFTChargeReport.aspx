<%@ Page Language="C#" AutoEventWireup="true" Codebehind="EFTChargeReport.aspx.cs" Inherits="EFTN.EFTChargeReport" %>
    ...
    <form id="form1" runat="server">
        <div class="maincontent" style="height:550px">
            ...
            <table  cellspacing="25px" cellpadding="25px">
                <tr> 
                    <td align="center"><a href="EFTChargeReportDateWise.aspx" class="CommandButton">Date Wise Report</a></td>
                    <td align="center"><a href="EFTChargeReportMonthWise.aspx" class="CommandButton">Month Wise Report</a></td>
                    <td align="center"><a href="EFTChargeReportAccountWise.aspx" class="CommandButton">Account Wise Report</a></td>
                </tr>                
            </table>
