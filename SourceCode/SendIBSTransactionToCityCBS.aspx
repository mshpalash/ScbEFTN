<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SendIBSTransactionToCityCBS.aspx.cs"
    Inherits="EFTN.SendIBSTransactionToCityCBS" %>
...
<head id="Head1" runat="server">
    <title>Send IBS Transaction To CBS</title>
                ...
                <div align="center" id="AvailDiv" runat="server" style="position: relative; overflow: auto;
                    ...
                    <asp:DataGrid ID="dtgEFTChecker" AlternatingItemStyle-BackColor="lightyellow" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:ButtonColumn CommandName="SendTransactionToCBS" Text="Send Transaction To CBS" CausesValidation="false"></asp:ButtonColumn>
