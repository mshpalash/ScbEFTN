<%@ Page Language="C#" AutoEventWireup="true" Codebehind="DishonorSentFiles.aspx.cs"
    Inherits="EFTN.DishonorSentFiles" %>
...
<head id="Head1" runat="server">
    <title>Dishonor Sent Files</title>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:LinkButton ID="btnSendToPBM" runat="server" Text="Send to PBM" OnClick="btnSendToPBM_Click"
                                    CssClass="CommandButton" OnClientClick="return confirm('Are you sure you want to send to PBM?')" />
                            </td>
                            <td>
