<%@ Page Language="C#" AutoEventWireup="true" Codebehind="OutwardCreditSummaryReport.aspx.cs" Inherits="EFTN.OutwardCreditSummaryReport" %>
...
<head id="Head1" runat="server">
    <title>outward Credit Summary Report</title>
    ...
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <asp:Label ID="lblStatusReport" CssClass="NormalRed" runat="Server"></asp:Label><br />
                <asp:DataGrid ID="dtgOutwardCreditSummaryReport" runat="Server" Width="600" BorderWidth="0px" GridLines="None"
