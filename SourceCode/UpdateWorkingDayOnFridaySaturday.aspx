<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateWorkingDayOnFridaySaturday.aspx.cs" Inherits="EFTN.UpdateWorkingDayOnFridaySaturday" %>
...
<div class="Head" align="center">
            Working Day Management for Firday and Saturday</div>
    <div align="center" class="boxmodule" style="padding-top:10px; width:500px; margin-top:10px; height:300px; margin-left:220px">
            ...
            <tr>
                ...
                <td>
                    <asp:Calendar ID="calendarHoliday" runat="server" BackColor="White" BorderColor="#3366CC" 
                        ...
                        Font-Size="8pt" ForeColor="#003399" Height="200px" Width="220px" SelectionMode="DayWeekMonth" OnVisibleMonthChanged="calendarHoliday_VisibleMonthChanged">
        ...
        <table>
            <tr>
                <td>
                    <asp:Label ID="lblMsg" runat="server" ForeColor="Red" Text="Select only Friday or Saturday to mark as working day"></asp:Label>
                </td>
            </tr>
        </table>
        <table>
