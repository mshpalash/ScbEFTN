<%@ Page Language="C#" AutoEventWireup="true" Codebehind="iBankingCBSReportChecker.aspx.cs"
    Inherits="EFTN.iBankingCBSReportChecker" %>
    ...
    <form id="form2" method="post" runat="server">
        <div class="maincontent">
            ...
            <div class="Head" align="center">
                iBanking CBS Status Report</div>
            <%--<div>
                        ...
                        <td>
                           <%-- <asp:DropDownList ID="ddListTransactionType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddListTransactionType_SelectedIndexChanged">--%>
                             <asp:DropDownList ID="ddListTransactionType" runat="server">
                                <asp:ListItem Value="0">UnSuccessfull</asp:ListItem>
                                <asp:ListItem Value="1">Successfull</asp:ListItem>
            ...
            <div style="overflow: auto; width: 940px; margin-left: 100px; margin-left: 15px">
                <asp:Panel ID="pnlReportSettlement" runat="server" Height="400px" Width="900px">
                    <asp:DataGrid ID="dtgSettlementReport" runat="Server" AlternatingItemStyle-BackColor="lightyellow"
                        ...
                        ItemStyle-CssClass="NormalSmall" ShowFooter="true" PagerStyle-Position="Top" OnPageIndexChanged="dtgSettlementReport_PageIndexChanged" PageSize="5000" AllowPaging="True" AllowSorting="True" OnSortCommand="dtgSettlementReport_SortCommand">
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="SL.">
                                <ItemTemplate>
                                   ...
                                   <asp:TemplateColumn  SortExpression = "CreatedBy" HeaderText="CreatedBy">
                                        <ItemTemplate>
                                            <%#DataBinder.Eval(Container.DataItem, "CreatedBy")%>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>

                                    <asp:TemplateColumn  SortExpression = "CheckedBy" HeaderText="CheckedBy">
                                        <ItemTemplate>
                                            <%#DataBinder.Eval(Container.DataItem, "CheckedBy")%>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                            
                                     <asp:TemplateColumn  SortExpression = "TxnSeqNo" HeaderText="TxnSeqNo">
                                        <ItemTemplate>
                                            <%#DataBinder.Eval(Container.DataItem, "TxnSeqNo")%>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>

                                       <asp:TemplateColumn  SortExpression = "FlatFileName" HeaderText="FlatFileName">
                                        <ItemTemplate>
                                            <%#DataBinder.Eval(Container.DataItem, "FlatFileName")%>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>

                            
                                       <asp:TemplateColumn  SortExpression = "eBBSResponse" HeaderText="eBBSResponse">
                                        <ItemTemplate>
                                            <%#DataBinder.Eval(Container.DataItem, "eBBSResponse")%>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>

                                    <asp:TemplateColumn  SortExpression = "RejectCode" HeaderText="RejectCode">
                                        <ItemTemplate>
                                            <%#DataBinder.Eval(Container.DataItem, "RejectCode")%>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>

                                    <asp:TemplateColumn  SortExpression = "eBBSRejectReason" HeaderText="eBBSRejectReason">
                                        <ItemTemplate>
                                            <%#DataBinder.Eval(Container.DataItem, "eBBSRejectReason")%>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                            </Columns>
