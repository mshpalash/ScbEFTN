<%@ Page Language="C#" AutoEventWireup="true" Codebehind="GenerateXMLForCardsCity.aspx.cs"
    Inherits="EFTN.GenerateXMLForCardsCity" %>
...
<head id="Head1" runat="server">
    <title>Generate XML files for Cards</title>
    ...
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div class="Head" align="center">
                Generate XML files for Cards</div> 
            <div>
            ...
            <table>
                    <tr>
                        ...
                        <td width="10"></td>
                        <td class="Normal">
                            <asp:LinkButton ID="btnGenerateXMLTransactionSent" runat="server" Text="Generate"
                                CssClass="CommandButton" OnClientClick="return confirm('Are you sure you want to generate XML for Cards?')"
                                OnClick="btnGenerateXMLTransactionSent_Click" /></td>
                    </tr>
            </table>
            </div>
