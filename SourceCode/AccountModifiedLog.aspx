<%@ Page Language="C#" AutoEventWireup="true" Codebehind="AccountModifiedLog.aspx.cs"
    Inherits="EFTN.AccountModifiedLog" %>
                ...
                <asp:Panel ID="pnlReportSettlement" runat="server" Height="400px" Width="900px">
                    <asp:DataGrid ID="dtgSettlementReport" runat="Server" AlternatingItemStyle-BackColor="lightyellow"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="LoginID" HeaderText="LoginID" SortExpression = "LoginID">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="DFIAccNo" HeaderText="DFIAccNo"  SortExpression = "DFIAccNo">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="ModDFIAccNo" HeaderText="ModDFIAccNo"  SortExpression = "ModDFIAccNo" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="UserID" HeaderText="UserID"  SortExpression = "UserID" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="PaymentInfo" HeaderText="PaymentInfo"  SortExpression = "PaymentInfo" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                        </Columns>
