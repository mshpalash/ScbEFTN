<%@ Page Language="C#" AutoEventWireup="true" Codebehind="AdvicePrintStatusCA.aspx.cs"
    Inherits="EFTN.AdvicePrintStatusCA" %>
...
<body class="wrap" id="content">
    <form id="form2" method="post" runat="server">
        <div class="maincontent">
            <uc1:HeaderCA ID="EFTHeader1" runat="server" />
            <div class="Head" align="center">
                Branch Wise Customer Advice Print Status</div>
            <div align="center" class="boxmodule" style="padding-top: 10px; width: 960px; margin-top: 10px;
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnPrintAdvice" runat="server" Text="Printed Advice" OnClick="btnPrintAdvice_Click"/>
                            <asp:Button ID="btnNonPrintAdvice" runat="server" Text="Non Printed Advice" OnClick="btnNonPrintAdvice_Click"/>
                        </td>
                    </tr>
                </table>
            </div>
            <div style="overflow: auto; width: 940px; margin-left: 100px; margin-left: 15px">
                <asp:Panel ID="pnlAdvicePrintStatus" runat="server" Height="400px" Width="400px">
                    <asp:DataGrid ID="dtgAdvicePrintStatus" runat="Server" AlternatingItemStyle-BackColor="lightyellow"
                        ...
                        ItemStyle-CssClass="NormalSmall" ShowFooter="true" PagerStyle-Position="Top" OnPageIndexChanged="dtgAdvicePrintStatus_PageIndexChanged" PageSize="500" AllowPaging="True" AllowSorting="True" OnSortCommand="dtgAdvicePrintStatus_SortCommand">
                        <Columns>
                            <asp:BoundColumn DataField="BranchName" HeaderText="BranchName" SortExpression = "BranchName">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="AdvicePrintTime" HeaderText="AdvicePrintTime"  SortExpression = "AdvicePrintTime" >
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>                           
                        </Columns>
