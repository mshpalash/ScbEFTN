<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SettlementReportMaker.aspx.cs" Inherits="EFTN.SettlementReportMaker" %>
...
<body class="wrap" id="content">
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div align="center" class="boxmodule" style="padding-top: 10px; width: 800px; margin-top: 10px; height: 40px">
                <table>
                    <tr>
                        <td class="NormalBold">
            ...
            <div align="center" id="AvailDiv" runat="server" style="position: relative; overflow: auto; height: 400px; padding-bottom: 20px;">
