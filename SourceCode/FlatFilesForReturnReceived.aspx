<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlatFilesForReturnReceived.aspx.cs"
    Inherits="EFTN.FlatFilesForReturnReceived" %>
...
<body class="wrap" id="content">
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div align="center" class="boxmodule" style="padding-top: 10px; width: 850px; margin-top: 10px; height: 40px; margin-left: 100px">
                <table>
                    <tr>
                        <td></td>
                        <td class="NormalBold">Received Transactions</td>
                        <td width="30"></td>
                        <td>
                        ...
                        <td class="NormalBold">Settltement Date</td>
                        <td>
                            <table>
                                <tr>
                                    <td class="NormalBold">
                        ...
                        <td class="Normal">
                            <asp:LinkButton ID="linkBtnFlatFileReturnReceived" runat="server" Text="Generate"
                                CssClass="CommandButton" OnClientClick="return confirm('Are you sure you want to generate flat files for CBS?')" OnClick="linkBtnFlatFileReturnReceived_Click" /></td>
                    </tr>
                </table>
            </div>
                ...
                <asp:DataGrid ID="dtgTransactionSentToOwnBank" runat="Server" Width="600" BorderWidth="0px"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="valueDate" HeaderText="valueDate" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="Narration1" HeaderText="Narration With Return Reason" ItemStyle-Wrap="False" ItemStyle-HorizontalAlign="Left"
                            HeaderStyle-Wrap="False" />
