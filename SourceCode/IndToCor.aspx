<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndToCor.aspx.cs" Inherits="EFTN.IndToCor" %>
    ...
    <form id="form2" method="post" runat="server">
        <div class="maincontent">
            ...
            <div class="Head" align="center">
                Individual to Corporate Transaction
            </div>
            <table>
                <tr>
                    <td width="100"></td>
                    <td>
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtReceiverName" runat="server" Width="150px" MaxLength="15" OnKeyUp="return makeUppercase(this.name);" onkeypress="return onlyEFTSpecialCharacter();"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtReceiverName"
                                        Display="Dynamic" CssClass="NormalRed" ErrorMessage="* Missing"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="NormalBold">ID Number with the Comapany:</td>
                                <td>
                                    <asp:TextBox ID="txtIDNumber" runat="server" Width="130px" MaxLength="15" OnKeyPress="return onlyEFTSpecialCharacter(this.name);"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="ReqtxtIDNumber" runat="server" ControlToValidate="txtIDNumber"
                                        Display="Dynamic" CssClass="NormalRed" ErrorMessage="* Missing"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <asp:Button ID="btnSaveAndSameBatch" CssClass="inputlt" runat="server" Text="Save"
                                        Width="100px" OnClick="btnSaveAndSameBatch_Click" OnClientClick="return validateDataField()" /><br />
                                </td>
                                <td>
                ...
                <asp:DataGrid ID="dtgXcelUpload" runat="Server" Width="600px" BorderWidth="0px"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="ReceiverName" SortExpression="ReceiverName">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtReceiverName" MaxLength="22" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"ReceiverName") %>' OnKeyPress="return onlyAlphaNumeric(this.name);"></asp:TextBox>
