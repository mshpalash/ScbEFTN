<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InwardReturnMaker.aspx.cs"
    Inherits="EFTN.InwardReturnMaker" MaintainScrollPositionOnPostback="true" %>
...
<body class="wrap" id="content">
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div align="center" class="boxmodule" style="padding-top: 10px; width: 970px; margin-top: 10px; height: 40px; margin-left: 5px">
                <table>
                    <tr align="left">
                        <td width="100">
                        ...
                        <td colspan="3">
                            <asp:DataGrid ID="dtgInwardReturnMaker" AlternatingItemStyle-BackColor="lightyellow"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn>
                                        <ItemTemplate>
                                            <a href="InwardReturnModifier.aspx?inwardReturnID=<%#DataBinder.Eval(Container.DataItem, "ReturnID")%>">Re-Generate As New Transaction</a>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
