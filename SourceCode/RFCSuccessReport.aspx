<%@ Page Language="C#" AutoEventWireup="true" Codebehind="RFCSuccessReport.aspx.cs"
    Inherits="EFTN.RFCSuccessReport" %>
        ...
        <div class="maincontent">
            ...
            <div align="center" class="boxmodule" style="padding-top: 10px; width: 960px; margin-top: 10px;
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddListSuccessStatus" runat="server">
                                <asp:ListItem Value="1" Text="Successful RFC"></asp:ListItem>
                                <asp:ListItem Value="0" Text="Unsuccessful RFC"></asp:ListItem>
                                 <asp:ListItem Value="11" Text="Successful Inward Return"></asp:ListItem>
                                <asp:ListItem Value="10" Text="Unsuccessful Inward Return"></asp:ListItem>
                                     <asp:ListItem Value="21" Text="Successful IBS"></asp:ListItem>
                                <asp:ListItem Value="20" Text="Unsuccessful IBS"></asp:ListItem>
                                  <asp:ListItem Value="30" Text="Missing IBS"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="2" align="left">
                            <asp:Label ID="lblTotalMsg" runat="server"></asp:Label>
                        </td>
                        <td colspan="4"></td>
                    </tr>
                </table>
            ...
            <div style="overflow: auto; width: 940px; margin-left: 100px; margin-left: 15px">
                <asp:Panel ID="pnlReportSettlement" runat="server" Height="400px" Width="900px">
                    <asp:DataGrid ID="dtgSuccessReport" runat="Server" AlternatingItemStyle-BackColor="lightyellow"
                        ...
                        ItemStyle-CssClass="NormalSmall" ShowFooter="true" PagerStyle-Position="Top" OnPageIndexChanged="dtgSuccessReport_PageIndexChanged" PageSize="50" AllowPaging="True">
                        <Columns>
                            <asp:TemplateColumn HeaderText="SL.">
                                <ItemTemplate>
                                    <%#(dtgSuccessReport.PageSize * dtgSuccessReport.CurrentPageIndex) + Container.ItemIndex + 1%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
