<%@ Page Language="C#" AutoEventWireup="true" Codebehind="TransactionReceiveCSVForUCB.aspx.cs"
    Inherits="EFTN.TransactionReceiveCSVForUCB" %>
...
<head id="Head1" runat="server">
    <title>Download Transaction Receive CSV</title>
    ...
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div class="Head" align="center">
                Download CSV for Transaction Receive</div> 
            <div>
            ...
            <table>
                    <tr>
                        ...
                        <td width="30"></td>
                        <td class="Normal">
                            <asp:LinkButton ID="linkBtnGenerateCSV" runat="server" Text="Generate"
                                CssClass="CommandButton" 
                                OnClientClick="return confirm('Are you sure you want to generate CSV for Transaction Receive?')" onclick="linkBtnGenerateCSV_Click"
                                /></td>
                    </tr>
            </table>
            </div>
