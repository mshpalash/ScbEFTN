<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerWiseReportMaker.aspx.cs" Inherits="EFTN.CustomerWiseReportMaker" %>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlistFromYear" runat="server" Width="55px">
...
--%>
            ...
            <div id="AvailDiv" runat="server" style="position: relative; overflow: auto;
                ...
                <asp:DataGrid ID="dtgCustomerWiseReport" runat="Server"  BorderWidth="0px"  Width="900px"
                    ...
                    ItemStyle-CssClass="Normal" AllowPaging="True" PageSize="500" OnPageIndexChanged="dtgCustomerWiseReport_PageIndexChanged">
                    ...
                    <Columns>
                        <asp:TemplateColumn HeaderText="SL.">
                          <HeaderStyle Wrap="true" Width="20px" Font-Bold="False" Font-Italic="False" 
                            ...
                            <ItemTemplate>
                                <%#(dtgCustomerWiseReport.PageSize * dtgCustomerWiseReport.CurrentPageIndex) + Container.ItemIndex + 1%>
                            </ItemTemplate>
                        </asp:TemplateColumn>
