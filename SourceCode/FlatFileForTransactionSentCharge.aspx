<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FlatFileForTransactionSentCharge.aspx.cs"
    Inherits="EFTN.FlatFileForTransactionSentCharge" %>
                ...
                <div align="center" id="AvailDiv" runat="server" style="position: relative; overflow: auto;
                    ...
                    <asp:DataGrid ID="dtgEFTChecker" AlternatingItemStyle-BackColor="lightyellow" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:ButtonColumn CommandName="GenerateFlatFile" Text="Generate Flat File For Charge" CausesValidation="false"></asp:ButtonColumn>
                            <asp:ButtonColumn CommandName="GenerateAccumulatedFlatFile" Text="Generate Accumulated Flat File for Charge" CausesValidation="false"></asp:ButtonColumn>
