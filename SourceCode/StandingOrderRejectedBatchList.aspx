<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StandingOrderRejectedBatchList.aspx.cs"
    Inherits="EFTN.StandingOrderRejectedBatchList" MaintainScrollPositionOnPostback="true" %>
            ...
            <div align="left">
                <table>
                    <tr>
                        <td width="50px"></td>
                        <td>
                            <asp:LinkButton ID="linkBtnDelete" runat="server" Text="Delete" CssClass="CommandButton" OnClientClick="return confirm('Are you sure you want to delete?')" OnClick="linkBtnDelete_Click"></asp:LinkButton>
                        </td>
                    </tr>
                </table>
                <table>
                                    ...
                                    <tr>
                                        <td class="NormalBold" align="center">
                                            <asp:DataGrid ID="dtgStandingOrderBatch" runat="Server" BorderWidth="0px" GridLines="None"
                                                ...
                                                FooterStyle-CssClass="GrayBackWhiteFont" HeaderStyle-CssClass="GrayBackWhiteFont" AllowPaging="True" PageSize="100"
                                                ItemStyle-BackColor="#dee9fc" AlternatingItemStyle-BackColor="#ffffff" DataKeyField="StandingOrderBatchID" OnPageIndexChanged="dtgStandingOrderBatch_PageIndexChanged" ShowFooter="True">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="">
                                                        <ItemTemplate>
                                                            <a href="StandingOrderTransactionList.aspx?StandingOrderBatchID=<%#DataBinder.Eval(Container.DataItem, "StandingOrderBatchID")%>">Batch Details</a>
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
