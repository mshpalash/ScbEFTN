<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetailSettlementReportAck.aspx.cs"
    Inherits="EFTN.DetailSettlementReportAck" %>
    ...
    <form id="form2" method="post" runat="server">
        <div class="maincontent">
            ...
            <div class="Head" align="center">
                Detail Settlement Report for Checker
            </div>
            <div>
            ...
            <div align="center" class="boxmodule" style="padding-top: 10px; width: 960px; margin-top: 10px; height: 80px; margin-left: 5px">
                <table>
                    <tr>
                        ...
                        <td style="height: 46px">
                            <asp:DropDownList ID="ddListReportType" runat="server" AutoPostBack="true"  OnSelectedIndexChanged="ddListReportType_SelectedIndexChanged">
                                <asp:ListItem Value="12" Text=" Ack Outward Transaction (Initial Transaction)" Selected="True"></asp:ListItem>
                                <asp:ListItem Value="8412" Text="Non Ack Outward Transaction (Initial Transaction)"></asp:ListItem>

                                <asp:ListItem Value="4" Text="Ack Outward Return "></asp:ListItem>
                                <asp:ListItem Value="844" Text="Non Ack Outward Return "></asp:ListItem>

                                <asp:ListItem Value="6" Text="Ack Outward NOC "></asp:ListItem>
                                <asp:ListItem Value="846" Text="Non Ack Outward NOC "></asp:ListItem>
                    ...
                    <asp:DataGrid ID="dtgSettlementReport" runat="Server" AlternatingItemStyle-BackColor="lightyellow"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="RejectReason" HeaderText="RejectReason/CorrectedData" SortExpression="RejectReason">
                              ...
                              <asp:BoundColumn DataField="TxnType" HeaderText="Tranaction Type" SortExpression="TxnType">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle Wrap="False" />
                            </asp:BoundColumn>
                        </Columns>
