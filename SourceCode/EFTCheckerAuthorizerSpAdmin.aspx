<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EFTCheckerAuthorizerSpAdmin.aspx.cs"MaintainScrollPositionOnPostback="true"Inherits="EFTN.EFTCheckerAuthorizerSpAdmin" %>
        ...
        <div style="overflow: scroll">
            <table width="900px" cellspacing="30">
                <tr>
                    <td valign="top" class="NormalBold" bgcolor="aliceblue" style="border: solid 1px #666666;
                        ...
                        <asp:LinkButton ID="linkBtnImportTransaction" runat="server" Text="Import Transaction"
                            OnClientClick="return confirm('Are you sure you want to import?')" OnClick="linkBtnImportTransaction_Click"></asp:LinkButton>
                        <br />
                    ...
                    <td valign="top" class="NormalBold" style="border: solid 1px #666666; width: 200px;
                        text-align: center; background-color: lightyellow">
                        <asp:LinkButton ID="linkBtnImportReturn" runat="server" Text="Import Return" OnClientClick="return confirm('Are you sure you want to import?')"
                    ...
                    <td valign="top" class="NormalBold" bgcolor="aliceblue" style="border: solid 1px #666666;
                        width: 200px" align="center">
                        <asp:LinkButton ID="linkBtnImportNOC" runat="server" Text="Import NOC" OnClientClick="return confirm('Are you sure you want to import?')"
                ...
                <tr>
                    <td valign="top" class="NormalBold" bgcolor="aliceblue" style="border: solid 1px #666666;
                        width: 200px" align="center">
                        <asp:LinkButton ID="linkBtnContested" runat="server" Text="Import Contested" OnClientClick="return confirm('Are you sure you want to import?')"
                            OnClick="linkBtnContested_Click"></asp:LinkButton>
                        <br />
                        <asp:DataList ID="dtListContested" runat="Server" ItemStyle-CssClass="Normal" ItemStyle-HorizontalAlign="Left"
                            ItemStyle-Wrap="false" BorderWidth="0" CellSpacing="1" CellPadding="2">
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container.DataItem,"FileName")%>
                            </ItemTemplate>
                    ...
                    <td valign="top" class="NormalBold" style="border: solid 1px #666666; width: 200px;
                        text-align: center; background-color: lightyellow">
                        <asp:LinkButton ID="linkBtnDishonor" runat="server" Text="Import Dishonor" OnClientClick="return confirm('Are you sure you want to import?')"
                    ...
                    <td valign="top" class="NormalBold" bgcolor="aliceblue" style="border: solid 1px #666666;
                        width: 200px" align="center">
                        <asp:LinkButton ID="linkBtnRNOC" runat="server" Text="Import RNOC" OnClientClick="return confirm('Are you sure you want to import?')"
                ...
                <tr>
                                            ...
                                            <tr>
                                                <td class="NormalBold" align="center">
                                                    <asp:DataGrid ID="dtGridTransactionError" runat="Server" BorderWidth="0px" GridLines="None"
                                                        ...
                                                        OnItemCommand="dtGridTransactionError_ItemCommand">
                                                        <Columns>
                                                            <asp:HyperLinkColumn DataTextField="FileName"></asp:HyperLinkColumn>
                                                            <asp:ButtonColumn CommandName="DownloadTRErrorFiles" Text="Download" CausesValidation="false">
                                                            </asp:ButtonColumn>
                                                            <asp:ButtonColumn CommandName="RemoveTRErrorFiles" Text="Delete" CausesValidation="false">
                                                            </asp:ButtonColumn>
                                                        </Columns>
                                                    </asp:DataGrid>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td>
                                    <asp:Label ID="Label8" runat="server" Font-Bold="true" ForeColor="Red" Text="Send TXN to PBM"></asp:Label>
                                    <div style="overflow: scroll; height: 200px;">
                                        <table>
                                            <tr>
                                                <td class="NormalBold" align="center">
                                                    <asp:DataGrid ID="dtgTransactionToSendPBM" runat="Server" BorderWidth="0px" GridLines="None"
                                                        AutoGenerateColumns="False" CellPadding="5" CellSpacing="1" ItemStyle-CssClass="NormalSmall"
                                                        FooterStyle-CssClass="GrayBackWhiteFont" HeaderStyle-CssClass="GrayBackWhiteFont"
                                                        ItemStyle-BackColor="#dee9fc" AlternatingItemStyle-BackColor="#ffffff" DataKeyField="FilePath"
                                                        OnItemCommand="dtgTransactionToSendPBM_ItemCommand">
                                                        <Columns>
                                                            <asp:TemplateColumn>
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="cbxSentBatchInTemp" runat="server" />
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                            <asp:HyperLinkColumn DataTextField="FileName"></asp:HyperLinkColumn>
                                                            <asp:ButtonColumn CommandName="DownloadTRSentTempFiles" Text="Download" CausesValidation="false">
                                                            </asp:ButtonColumn>
                                                        </Columns>
                                                    </asp:DataGrid>
                                                </td>
                            ...
                            <tr>
                                <td>
                                    <table>
                                        <tr>
                                            <td colspan="5">
                                                <asp:Label ID="Label9" CssClass="NormalRed" runat="server" Text=""></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:CheckBox ID="chkBoxSendTXNTempToPBM" runat="server" Text="Select All" CssClass="NormalBold"
                                                    AutoPostBack="true" 
                                                    oncheckedchanged="chkBoxSendTXNTempToPBM_CheckedChanged" />
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            </td>
                                            <td width="10px"></td>
                                            <td>
                                                <asp:LinkButton ID="linkBtnMoveTRSentTempFiles" runat="server" 
                                                    Text="Send to PBM" CssClass="CommandButton"
                                                    OnClientClick="return confirm('Are you sure you want to Send the batch?')" 
                                                    onclick="linkBtnMoveTRSentTempFiles_Click" />
                                            </td>
                                            <td width="10px"></td>
                                            <td>
                                                <asp:LinkButton ID="linkBtnDeleteTRSentTempFiles" runat="server" Text="Delete" CssClass="CommandButton"
                                                    
                                                    OnClientClick="return confirm('Are you sure you want to delete the batch?')" 
                                                    onclick="linkBtnDeleteTRSentTempFiles_Click" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblTransactionSendPBM" CssClass="NormalRed" runat="server" Text=""></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td>
                                    ...
                                    <div style="overflow: scroll; height: 200px;">
                                        <table>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:LinkButton ID="lnkBtnImportTransSentACK" CssClass="CommandButton" runat="server"
                                                        Text="Import Acknowledgement" OnClick="lnkBtnImportTransSentACK_Click"></asp:LinkButton>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                ...
                                <td>
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:LinkButton ID="btnDeleteBatchSent" runat="server" Text="Delete" CssClass="CommandButton"
                                                    OnClientClick="return confirm('Are you sure you want to delete the batch?')"
                                            ...
                                            <tr>
                                                <td class="NormalBold" align="center">
                                                    <asp:DataGrid ID="dtgBatchReturnSent" runat="Server" BorderWidth="0px" GridLines="None"
                                                        ...
                                                        AlternatingItemStyle-BackColor="#ffffff" DataKeyField="TransactionID">
                                                        <Columns>
                                                            <asp:TemplateColumn>
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateColumn HeaderText="ReCheck Return">
                                                                <ItemTemplate>
                                                                    <a href="InwardTransactionReturnRecheck.aspx?TransactionID=<%#DataBinder.Eval(Container.DataItem, "TransactionID")%>">
                                                                        Batch Details</a>
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                            <asp:BoundColumn DataField="BatchNumber" HeaderText="BatchNo" ItemStyle-Wrap="False"
