<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatusReportMaker.aspx.cs"
    Inherits="EFTN.StatusReportMaker" %>
...
<body class="wrap" id="content">
    <form id="form1" runat="server">
        <div class="maincontent">
            ...
            <div id="AvailDiv" runat="server" align="center" class="boxmodule" style="padding-top: 10px; width: 780px; margin-top: 10px; height: 40px; margin-left: 200px;">
                <table>
                    <tr>
                        <td class="NormalBold">
            ...
            <div style="overflow: auto; width: 750px; margin-left: 200px">
                ...
                <asp:DataGrid ID="dtgStatusReport" runat="Server" Width="600" BorderWidth="0px" GridLines="None"
                    ...
                    <Columns>
                        <asp:BoundColumn DataField="TableName" HeaderText="TableName" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="Registered" HeaderText="Registered" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="Pending" HeaderText="Pending" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" />
                        <asp:BoundColumn DataField="Processed" HeaderText="Processed" ItemStyle-Wrap="False"
                            HeaderStyle-Wrap="False" />
                    </Columns>
                </asp:DataGrid>
            </div>
